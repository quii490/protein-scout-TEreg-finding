...
## 2. HPA 精子定位证据
- **来源:** Principal piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000065371-ROPN1
- **IF 图像:** 已获取 (2 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (2 张 blue_red_green)。
![](https://images.proteinatlas.org/52530/2205_B8_6_blue_red_green.jpg)
![](https://images.proteinatlas.org/52530/2205_B8_1_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->
...
AlphaFold 数据可用 (UniProt: C9J6H4)。参见 https://alphafold.ebi.ac.uk/entry/C9J6H4
...
| ROPN1B | 0.884 | 0.000 | 0.000 | 0.000 |
