...
## 1. 基本信息
- **基因:** DUSP21
- **蛋白名称:** Dual specificity protein phosphatase 21
- **Ensembl:** ENSG00000189037
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 9 篇
- **精子定位部位:** Connecting piece、Mid piece、Principal piece (3 个)
- **UniProt Subcellular Location:** Cytoplasm; Nucleus; Mitochondrion inner membrane; Cytoplasm, cytoskeleton, flagellum axoneme
