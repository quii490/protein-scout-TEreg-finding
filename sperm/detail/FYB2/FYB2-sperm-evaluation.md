...
- **IF 可靠性:** 未获取
- **PubMed:** 3 篇
- **精子定位部位:** Mid piece、Perinuclear theca、Principal piece (3 个)
- **UniProt Subcellular Location:** GO: immunological synapse; membrane raft; plasma membrane

## 2. HPA 精子定位证据
- **来源:** Mid piece、Perinuclear theca、Principal piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000187889-FYB2
- **IF 图像:** 已获取 (2 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (2 张 blue_red_green)。
![](https://images.proteinatlas.org/54923/2205_B7_21_blue_red_green.jpg)
![](https://images.proteinatlas.org/54923/2205_B7_31_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->
...
AlphaFold 数据可用 (UniProt: A0ACI8VNC2)。参见 https://alphafold.ebi.ac.uk/entry/A0ACI8VNC2
...
## 9. 人工复核备注
- 精子部位: Mid piece、Perinuclear theca、Principal piece
- 建议验证精子 IF 文献定位
