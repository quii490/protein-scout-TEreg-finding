...
- **IF 可靠性:** 未获取
- **PubMed:** 43 篇
- **精子定位部位:** Equatorial segment、Mid piece (2 个)
- **UniProt Subcellular Location:** Endoplasmic reticulum

## 2. HPA 精子定位证据
- **来源:** Equatorial segment、Mid piece ✓
- **链接:** https://www.proteinatlas.org/-CLGN
- **IF 图像:** 未获取
...
## 9. 人工复核备注
- 精子部位: Equatorial segment、Mid piece
- 建议验证精子 IF 文献定位
