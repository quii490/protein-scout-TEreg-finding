...
## 1. 基本信息
- **基因:** NBPF19
- **蛋白名称:** NBPF family member NBPF19
- **Ensembl:** ENSG00000271383
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 1 篇
...
- **链接:** https://www.proteinatlas.org/ENSG00000271383-NBPF19
- **IF 图像:** 已获取 (6 张)
...
UniProt: A0A087WUL8 — NBPF family member NBPF19.
GO-CC 精子相关: 待进一步查询 UniProt subcellular location。
InterPro: NBPF, Olduvai_dom。
Pfam: Olduvai。
...
AlphaFold 数据可用 (UniProt: A0A087WUL8)。参见 https://alphafold.ebi.ac.uk/entry/A0A087WUL8
...
|---|---|---|---|---|
| NBPF19 | 0.791 | 0.000 | 0.000 | 0.000 |
| NOTCH2NLC | 0.722 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.668 | 0.000 | 0.000 | 0.000 |
| NOTCH2NLA | 0.609 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.581 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.546 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.515 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.438 | 0.000 | 0.000 | 0.000 |
| NOTCH2NLB | 0.410 | 0.000 | 0.000 | 0.000 |
| NBPF19 | 0.402 | 0.000 | 0.000 | 0.000 |
