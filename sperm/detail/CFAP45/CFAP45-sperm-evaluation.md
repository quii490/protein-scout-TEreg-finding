...
## 1. 基本信息
- **基因:** CFAP45
- **蛋白名称:** Cilia- and flagella-associated protein 45
- **Ensembl:** ENSG00000213085
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 22 篇
...
- **链接:** https://www.proteinatlas.org/ENSG00000213085-CFAP45
- **IF 图像:** 已获取 (6 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (6 张 blue_red_green)。
![](https://images.proteinatlas.org/42204/2205_C11_36_blue_red_green.jpg)
![](https://images.proteinatlas.org/42204/2210_G9_14_blue_red_green.jpg)
![](https://images.proteinatlas.org/42204/2201_E5_42_blue_red_green.jpg)
![](https://images.proteinatlas.org/42204/2184_E7_13_blue_red_green.jpg)
![](https://images.proteinatlas.org/42204/2201_E5_18_blue_red_green.jpg)
![](https://images.proteinatlas.org/42204/2184_E7_36_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->



## 3. UniProt / GO-CC 精子定位证据
UniProt: A0A087WUV1 — Cilia- and flagella-associated protein 45.
GO-CC 精子相关: 待进一步查询 UniProt subcellular location。
InterPro: CFAP45, TPH_dom。
Pfam: TPH。
...
AlphaFold 数据可用 (UniProt: A0A087WUV1)。参见 https://alphafold.ebi.ac.uk/entry/A0A087WUV1
...
|---|---|---|
| ENKUR | validated two hybrid | 32296183 |
