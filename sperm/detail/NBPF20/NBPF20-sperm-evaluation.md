...
## 1. 基本信息
- **基因:** NBPF20
- **蛋白名称:** NBPF family member NBPF20
- **Ensembl:** ENSG00000162825
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 7 篇
...
- **链接:** https://www.proteinatlas.org/ENSG00000162825-NBPF20
- **IF 图像:** 已获取 (6 张)
...
UniProt: P0DPF2 — NBPF family member NBPF20.
...
AlphaFold 数据可用 (UniProt: P0DPF2)。参见 https://alphafold.ebi.ac.uk/entry/P0DPF2
...
|---|---|---|---|---|
| NBPF20 | 0.507 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.473 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.449 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.449 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.445 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.445 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.418 | 0.000 | 0.000 | 0.000 |
| NBPF20 | 0.408 | 0.000 | 0.000 | 0.000 |
