...
## 1. 基本信息
- **基因:** NDUFA11
- **蛋白名称:** NADH dehydrogenase [ubiquinone] 1 alpha subcomplex subunit 11
...
- **链接:** https://www.proteinatlas.org/ENSG00000174886-NDUFA11
- **IF 图像:** 已获取 (6 张)
...
UniProt: Q86Y39 — NADH dehydrogenase [ubiquinone] 1 alpha subcomplex subunit 11.
...
AlphaFold 数据可用 (UniProt: Q86Y39)。参见 https://alphafold.ebi.ac.uk/entry/Q86Y39
...
| NDUFA11 | 0.999 | 0.000 | 0.000 | 0.000 |
...
| LYRM6 | anti bait coimmunoprecipitation | 12611891 |
| FAM136A | anti tag coimmunoprecipitation | 27499296 |
| NDUFS3 | anti tag coimmunoprecipitation | 27499296 |
