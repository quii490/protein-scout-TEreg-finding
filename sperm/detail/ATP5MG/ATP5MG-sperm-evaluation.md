...
## 2. HPA 精子定位证据
- **来源:** Principal piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000167283-ATP5MG
- **IF 图像:** 已获取 (6 张)
...
AlphaFold 数据可用 (UniProt: A0A8I5KSQ4)。参见 https://alphafold.ebi.ac.uk/entry/A0A8I5KSQ4
