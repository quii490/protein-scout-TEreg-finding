...
- **PubMed:** 46 篇
- **精子定位部位:** Acrosome (1 个)
- **UniProt Subcellular Location:** Cytoplasmic vesicle, secretory vesicle, acrosome inner membrane

## 2. HPA 精子定位证据
- **来源:** Acrosome ✓
- **链接:** https://www.proteinatlas.org/ENSG00000118434-SPACA1
- **IF 图像:** 已获取 (2 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (2 张 blue_red_green)。
![](https://images.proteinatlas.org/43297/2217_C11_21_blue_red_green.jpg)
![](https://images.proteinatlas.org/43297/2217_C11_36_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->



## 3. UniProt / GO-CC 精子定位证据
UniProt: Q9HBV2 — Sperm acrosome membrane-associated protein 1.
...
AlphaFold 数据可用 (UniProt: Q9HBV2)。参见 https://alphafold.ebi.ac.uk/entry/Q9HBV2
...
|---|---|---|---|---|
| SPATA16 | 0.898 | 0.000 | 0.000 | 0.000 |
| SPACA1 | 0.835 | 0.000 | 0.000 | 0.000 |
| DPY19L2 | 0.835 | 0.000 | 0.000 | 0.000 |
| IZUMO1 | 0.794 | 0.000 | 0.000 | 0.000 |
| SPATA16 | 0.792 | 0.000 | 0.000 | 0.000 |
| DPY19L2 | 0.766 | 0.000 | 0.000 | 0.000 |
| SSMEM1 | 0.714 | 0.000 | 0.000 | 0.000 |
