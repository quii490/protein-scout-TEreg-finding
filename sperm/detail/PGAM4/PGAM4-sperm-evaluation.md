...
## 1. 基本信息
- **基因:** PGAM4
- **蛋白名称:** Probable phosphoglycerate mutase 4
- **Ensembl:** ENSG00000226784
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 9 篇
- **精子定位部位:** Mid piece (1 个)
- **UniProt Subcellular Location:** GO: extracellular exosome; sperm principal piece

## 2. HPA 精子定位证据
- **来源:** Mid piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000226784-PGAM4
- **IF 图像:** 已获取 (6 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (6 张 blue_red_green)。
![](https://images.proteinatlas.org/42528/2183_B11_14_blue_red_green.jpg)
![](https://images.proteinatlas.org/42528/2204_G10_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/60483/1218_G12_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/42528/807_F5_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/42528/2204_G10_36_blue_red_green.jpg)
![](https://images.proteinatlas.org/42528/2184_D11_25_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->



## 3. UniProt / GO-CC 精子定位证据
UniProt: Q8N0Y7 — Probable phosphoglycerate mutase 4.
GO-CC 精子相关: 待进一步查询 UniProt subcellular location。
InterPro: His_Pase_superF_clade-1, His_PPase_superfam, PG/BPGM_mutase_AS, Phosphogly_mut1。
Pfam: His_Phos_1。
...
AlphaFold 数据可用 (UniProt: Q8N0Y7)。参见 https://alphafold.ebi.ac.uk/entry/Q8N0Y7
...
|---|---|---|---|---|
| PGK1 | 0.999 | 0.000 | 0.000 | 0.000 |
| GPI | 0.999 | 0.000 | 0.000 | 0.000 |
| ENO1 | 0.998 | 0.000 | 0.000 | 0.000 |
| PGK2 | 0.998 | 0.000 | 0.000 | 0.000 |
| ALDOA | 0.997 | 0.000 | 0.000 | 0.000 |
| ENO1 | 0.996 | 0.000 | 0.000 | 0.000 |
| PGAM4 | 0.994 | 0.000 | 0.000 | 0.000 |
