...
## 1. 基本信息
- **基因:** NBPF14
- **蛋白名称:** NBPF family member NBPF14
- **Ensembl:** ENSG00000270629
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 6 篇
...
- **链接:** https://www.proteinatlas.org/ENSG00000270629-NBPF14
- **IF 图像:** 已获取 (6 张)
...
UniProt: Q5TI25 — NBPF family member NBPF14.
...
AlphaFold 数据可用 (UniProt: Q5TI25)。参见 https://alphafold.ebi.ac.uk/entry/Q5TI25
...
|---|---|---|---|---|
| PPIAL4F | 0.492 | 0.000 | 0.000 | 0.000 |
| NBPF14 | 0.490 | 0.000 | 0.000 | 0.000 |
| NBPF14 | 0.447 | 0.000 | 0.000 | 0.000 |
| SPDYE5 | 0.446 | 0.000 | 0.000 | 0.000 |
| NBPF14 | 0.441 | 0.000 | 0.000 | 0.000 |
| NBPF14 | 0.434 | 0.000 | 0.000 | 0.000 |
| NBPF14 | 0.429 | 0.000 | 0.000 | 0.000 |
