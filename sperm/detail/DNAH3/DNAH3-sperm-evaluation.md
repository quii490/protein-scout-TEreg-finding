...
## 1. 基本信息
- **基因:** DNAH3
- **蛋白名称:** Dynein axonemal heavy chain 3
- **Ensembl:** ENSG00000158486
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 33 篇
- **精子定位部位:** Equatorial segment、Flagellar centriole、Mid piece、Principal piece (4 个)
...
## 9. 人工复核备注
- 精子部位: Equatorial segment、Flagellar centriole、Mid piece、Principal piece
- 建议验证精子 IF 文献定位
