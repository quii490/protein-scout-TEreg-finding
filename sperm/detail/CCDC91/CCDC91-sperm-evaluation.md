...
- **IF 可靠性:** 未获取
- **PubMed:** 24 篇
- **精子定位部位:** Acrosome、Equatorial segment、Flagellar centriole (3 个)
- **UniProt Subcellular Location:** GO: cytosol; Golgi apparatus; membrane; trans-Golgi network

## 2. HPA 精子定位证据
- **来源:** Acrosome、Equatorial segment、Flagellar centriole ✓
- **链接:** https://www.proteinatlas.org/-CCDC91
- **IF 图像:** 未获取
...
## 4. PubMed 文献证据
- **文献数:** 24 篇 (低研究量)
- 1. PMID 36292606: A Comparative Cross-Platform Analysis to Identify Potential Biomarker Genes for Evaluation of Teratozoospermia and Azoospermia. (2022 Sep 25) *Genes (Basel)*
...
## 9. 人工复核备注
- 精子部位: Acrosome、Equatorial segment、Flagellar centriole
- 建议验证精子 IF 文献定位
