...
- **IF 可靠性:** 未获取
- **PubMed:** 91 篇
- **精子定位部位:** Acrosome、Annulus、Mid piece、Principal piece (4 个)
- **UniProt Subcellular Location:** GO: centriole; centrosome; cytosol

## 2. HPA 精子定位证据
- **来源:** Acrosome、Annulus、Mid piece、Principal piece ✓
- **链接:** https://www.proteinatlas.org/-CEP135
- **IF 图像:** 未获取
...
| CENPJ | 0.995 | 0.000 | 0.000 | 0.000 |
| CENPJ | 0.994 | 0.000 | 0.000 | 0.000 |

### IntAct 实验验证 PPI (Detection 方法)
| Partner | Detection | PMID |
|---|---|---|
| WRAP73 | anti bait coimmunoprecipitation | 17353931 |
| WRAP73 | anti bait coimmunoprecipitation | 17353931 |
| CARD9 | anti tag coimmunoprecipitation | 28514442 |
| TANK | virotrap | 30561431 |
| NDEL1 | two hybrid fragment pooling approach | 31413325 |
...
| 维度 | 评分 | 依据 |
|---|---:|---|
| 精子定位 | 19/20 | 4 部位: Acrosome、Annulus、Mid piece、Principal piece |
| PubMed | 6/20 | 91 篇 |
| PPI | 18/20 | STRING |
| 结构 | 5/10 | 待采集 |
| 新颖性 | 4/10 | 较多 |
...
## 9. 人工复核备注
- 精子部位: Acrosome、Annulus、Mid piece、Principal piece
- 建议验证精子 IF 文献定位
