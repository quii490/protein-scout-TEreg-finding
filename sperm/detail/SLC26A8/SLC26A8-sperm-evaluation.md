...
- **IF 可靠性:** 未获取
- **PubMed:** 56 篇
- **精子定位部位:** Acrosome、Annulus (2 个)
- **UniProt Subcellular Location:** GO: plasma membrane; sperm annulus

## 2. HPA 精子定位证据
- **来源:** Acrosome、Annulus ✓
- **链接:** https://www.proteinatlas.org/ENSG00000112053-SLC26A8
- **IF 图像:** 已获取 (4 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (4 张 blue_red_green)。
![](https://images.proteinatlas.org/38080/2228_C8_41_blue_red_green.jpg)
![](https://images.proteinatlas.org/61393/2238_G6_36_blue_red_green.jpg)
![](https://images.proteinatlas.org/61393/2238_G6_29_blue_red_green.jpg)
![](https://images.proteinatlas.org/38080/2228_C8_16_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->
...
AlphaFold 数据可用 (UniProt: H7C5E6)。参见 https://alphafold.ebi.ac.uk/entry/H7C5E6
...
| ECT2 | 0.999 | 0.000 | 0.000 | 0.000 |
| RACGAP1 | 0.999 | 0.000 | 0.000 | 0.000 |
| RACGAP1 | 0.997 | 0.000 | 0.000 | 0.000 |
| ECT2 | 0.994 | 0.000 | 0.000 | 0.000 |
| ANLN | 0.989 | 0.000 | 0.000 | 0.000 |
| RACGAP1 | 0.950 | 0.000 | 0.000 | 0.000 |
...
| 维度 | 评分 | 依据 |
|---|---:|---|
| 精子定位 | 16/20 | 双部位: Acrosome、Annulus |
| PubMed | 7/20 | 56 篇 |
| PPI | 18/20 | STRING |
