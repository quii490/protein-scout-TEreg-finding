...
- **链接:** https://www.proteinatlas.org/ENSG00000219481-NBPF1
- **IF 图像:** 已获取 (6 张)
...
AlphaFold 数据可用 (UniProt: Q4VC10)。参见 https://alphafold.ebi.ac.uk/entry/Q4VC10
...
|---|---|---|---|---|
| SRGAP2 | 0.951 | 0.000 | 0.000 | 0.000 |
| HYDIN | 0.914 | 0.000 | 0.000 | 0.000 |
| SRGAP2 | 0.883 | 0.000 | 0.000 | 0.000 |
| HYDIN | 0.875 | 0.000 | 0.000 | 0.000 |
| NBPF1 | 0.861 | 0.000 | 0.000 | 0.000 |
| SRGAP2 | 0.858 | 0.000 | 0.000 | 0.000 |
| NBPF1 | 0.857 | 0.000 | 0.000 | 0.000 |
