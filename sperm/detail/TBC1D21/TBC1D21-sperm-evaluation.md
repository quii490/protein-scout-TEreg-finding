...
## 2. HPA 精子定位证据
- **来源:** Calyx、Mid piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000167139-TBC1D21
- **IF 图像:** 已获取 (4 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (4 张 blue_red_green)。
![](https://images.proteinatlas.org/43319/2195_A2_26_blue_red_green.jpg)
![](https://images.proteinatlas.org/43319/2195_A2_16_blue_red_green.jpg)
![](https://images.proteinatlas.org/43319/469_E7_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/43319/469_E7_1_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->
...
InterPro: Rab-GAP-TBC_dom, Rab-GAP_TBC_sf。
Pfam: RabGAP-TBC。
...
AlphaFold 数据可用 (UniProt: H3BTA9)。参见 https://alphafold.ebi.ac.uk/entry/H3BTA9
...
|---|---|---|---|---|
| TBC1D21 | 0.664 | 0.000 | 0.000 | 0.000 |
| TBC1D22B | 0.645 | 0.000 | 0.000 | 0.000 |
| TBC1D13 | 0.641 | 0.000 | 0.000 | 0.000 |
| TBC1D10A | 0.641 | 0.000 | 0.000 | 0.000 |
| TBC1D13 | 0.634 | 0.000 | 0.000 | 0.000 |
| TBC1D10A | 0.631 | 0.000 | 0.000 | 0.000 |
| TBC1D21 | 0.628 | 0.000 | 0.000 | 0.000 |
