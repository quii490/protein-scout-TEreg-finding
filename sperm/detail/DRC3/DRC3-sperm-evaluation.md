...
## 1. 基本信息
- **基因:** DRC3
- **Ensembl:** ENSG00000171962
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 26 篇
- **精子定位部位:** End piece、Mid piece、Principal piece (3 个)
- **UniProt Subcellular Location:** GO: axonemal doublet microtubule; axoneme; cilium; cytoplasm; sperm flagellum

## 2. HPA 精子定位证据
- **来源:** End piece、Mid piece、Principal piece ✓
- **链接:** https://www.proteinatlas.org/ENSG00000171962-DRC3
- **IF 图像:** 已获取 (2 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (2 张 blue_red_green)。
![](https://images.proteinatlas.org/36040/2218_E6_16_blue_red_green.jpg)
![](https://images.proteinatlas.org/36040/2218_E6_21_blue_red_green.jpg)
<!-- SPERM_HPA_IF_END -->
...
AlphaFold 数据可用 (UniProt: A0ACI8RL16)。参见 https://alphafold.ebi.ac.uk/entry/A0ACI8RL16
...
| CCDC114 | 0.863 | 0.000 | 0.000 | 0.000 |
...
|---|---|---|
| EPS8L1 | anti tag coimmunoprecipitation | 28514442 |
| ZNF647 | two hybrid array | 32296183 |
| ZNF647 | validated two hybrid | 32296183 |
| CDK15 | anti tag coimmunoprecipitation | 28514442 |
| TBC1D22B | anti tag coimmunoprecipitation | 28514442 |
| EPS8L1 | two hybrid array | 32296183 |
| EPS8L1 | validated two hybrid | 32296183 |
| CYSRT1 | validated two hybrid | 32296183 |
| EPS8L1 | two hybrid prey pooling approach | 32296183 |
| EPS8L1 | two hybrid prey pooling approach | 32296183 |
