...
- **链接:** https://www.proteinatlas.org/ENSG00000275969-SPATA31A3
- **IF 图像:** 已获取 (2 张)
...
UniProt: Q5VYP0 — Spermatogenesis-associated protein 31A3.
...
AlphaFold 数据可用 (UniProt: Q5VYP0)。参见 https://alphafold.ebi.ac.uk/entry/Q5VYP0
...
|---|---|---|---|---|
| SPATA31A3 | 0.621 | 0.000 | 0.000 | 0.000 |
