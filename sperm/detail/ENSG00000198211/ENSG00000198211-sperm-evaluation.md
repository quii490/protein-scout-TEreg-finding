...
# ENSG00000198211 — 精子模块评估

## 1. 基本信息
- **基因:** ENSG00000198211
- **Ensembl:** ENSG00000198211
- **抗体:** 未获取
- **IF 可靠性:** 未获取
- **PubMed:** 0 篇
...
- **链接:** https://www.proteinatlas.org/ENSG00000198211-ENSG00000198211
- **IF 图像:** 已获取 (6 张)


<!-- SPERM_HPA_IF_START -->
**HPA IF 图像（2026-06-22）**: HPA subcellular 页面有 IF 图像 (6 张 blue_red_green)。
![](https://images.proteinatlas.org/11512/642_E2_1_blue_red_green.jpg)
...
| TUBA1C | 0.691 | 0.000 | 0.000 | 0.000 |
| CKAP5 | 0.683 | 0.000 | 0.000 | 0.000 |
| TUBA1B | 0.676 | 0.000 | 0.000 | 0.000 |
| TUBA1A | 0.673 | 0.000 | 0.000 | 0.000 |
| WDR90 | 0.653 | 0.000 | 0.000 | 0.000 |
| TUBA1B | 0.653 | 0.000 | 0.000 | 0.000 |
