...
| 蛋白 | Protein FAM9C |
| 大小 | 166 aa |
| AlphaFold pLDDT | N/A (uncollected) |
| PubMed strict | 0 |
| PDB | 0 entries |
...
**原报告问题**: 原 49-line rejected 报告含有以下 harvest data collection issue (now resolved) 迹象：
- UniProt `?` — 实际 accession 为 Q8IZT9，定位为 Nucleus ECO:0000269
- AlphaFold pLDDT: N/A — 实际值为 ?
...
- AlphaFold pLDDT: N/A (harvest packet did not collect)
- PAE: 暂无数据（未生成 PAE 图片）
- PDB: 0 entries
...
| 三维结构 | 3/10 | ×3 | 9 | pLDDT=N/A (harvest uncollected) |
