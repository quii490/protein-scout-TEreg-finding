...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000101096-NFATC2/subcellular

![](https://images.proteinatlas.org/8789/18_H10_1_red_green.jpg)
![](https://images.proteinatlas.org/8789/18_H10_2_red_green.jpg)
![](https://images.proteinatlas.org/8789/19_H10_1_red_green.jpg)
![](https://images.proteinatlas.org/8789/19_H10_2_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q13469-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | Q13469 |
| SMART | SM00429; |
| UniProt Domain [FT] | DOMAIN 392..574; /note="RHD"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00265" |
| InterPro | IPR013783;IPR014756;IPR002909;IPR008366;IPR008967;IPR032397;IPR011539;IPR037059; |
| Pfam | PF16179;PF00554; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000101096-NFATC2/interaction
