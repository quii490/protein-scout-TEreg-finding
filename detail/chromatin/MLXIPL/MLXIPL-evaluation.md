...
gene: "MLXIPL"
date: 2026-06-03
tags: [protein-scout, rejected-nuclear, re-evaluation, recovery]
status: rejected
category: rejected
...
## MLXIPL — REJECTED (PubMed 127 > 100)

> **拒因**: PubMed 127 > 100。
> **数据来源**: HPA(Nucleoplasm), UniProt(Cytoplasm; Nucleus), GO-CC(chromatin, cytoplasm, cytosol)
> **PubMed (strict)**: 127
...
- [ ] 设计体外实验验证核定位及潜在调控功能
- [ ] **REJECTED: PubMed 127 > 100，不建议作为核蛋白研究目标。**
...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000009950-MLXIPL/subcellular

![](https://images.proteinatlas.org/64640/1209_C1_1_red_green.jpg)
![](https://images.proteinatlas.org/64640/1209_C1_2_red_green.jpg)
![](https://images.proteinatlas.org/64640/1215_C1_1_red_green.jpg)
![](https://images.proteinatlas.org/64640/1215_C1_3_red_green.jpg)
![](https://images.proteinatlas.org/64640/1294_D5_1_red_green.jpg)
![](https://images.proteinatlas.org/64640/1294_D5_3_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q9NP71-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | Q9NP71 |
| SMART | SM00353; |
| UniProt Domain [FT] | DOMAIN 649..703; /note="bHLH"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00981" |
| InterPro | IPR011598;IPR036638;IPR052207; |
| Pfam | PF00010; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000009950-MLXIPL/interaction
