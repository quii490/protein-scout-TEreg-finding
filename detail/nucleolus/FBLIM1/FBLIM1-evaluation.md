...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Cell Junctions (enhanced)。来源: https://www.proteinatlas.org/ENSG00000162458-FBLIM1/subcellular

![](https://images.proteinatlas.org/25287/1591_E2_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/25287/1591_E2_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/25287/1685_H3_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/25287/1685_H3_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/72750/1556_B9_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/72750/1556_B9_2_blue_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q8WUP2-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | Q8WUP2 |
| SMART | SM00132; |
| UniProt Domain [FT] | DOMAIN 181..242; /note="LIM zinc-binding 1"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00125"; DOMAIN 243..300; /note="LIM zinc-binding 2"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00125"; DOMAIN 301..370; /note="LIM zinc-binding 3"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00125" |
| InterPro | IPR001781; |
| Pfam | PF00412; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000162458-FBLIM1/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| CUTA | Intact, Biogrid | true |
| H3C1 | Intact, Biogrid | true |
| FERMT2 | Biogrid | false |
| FLNA | Biogrid | false |
| FLNB | Biogrid | false |
| H3-5 | Intact | false |
| H3C10 | Intact | false |
