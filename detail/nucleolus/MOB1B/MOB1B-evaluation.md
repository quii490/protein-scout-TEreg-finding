...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000173542-MOB1B/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-Q7L9L4-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000173542-MOB1B/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| LATS1 | Intact, Biogrid | true |
| LATS2 | Intact, Biogrid, Bioplex | true |
| STK3 | Intact, Biogrid | true |
| STK38L | Biogrid, Bioplex | true |
| STK4 | Intact, Biogrid | true |
| AJUBA | Bioplex | false |
| ANKRD28 | Biogrid | false |
| ANKRD52 | Biogrid | false |
