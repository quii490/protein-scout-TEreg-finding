...
## CT45A2 (Cancer/testis antigen family 45 member A2) 核蛋白评估报告
...
|---|---|
| 基因名 | CT45A2 |
| 蛋白全称 | Cancer/testis antigen family 45 member A2 |
| UniProt ID | Q5DJT8 |
...
| 蛋白大小 | 5/10 | x1 | 5.0 | 189 aa |
| 研究新颖性 | 10/10 | x5 | 50.0 | PubMed=0; TrEMBL条目 |
| 三维结构 | 6/10 | x3 | 18.0 | AF pLDDT可用; 无实验PDB结构 |
| 调控结构域 | 6/10 | x2 | 12.0 | InterPro:IPR029307; InterPro:IPR051113; Pfam:PF15300 |
...
HPA 检索: https://www.proteinatlas.org/search/CT45A2

### ESMFold 结构预测

**方法**: Meta ESM Metagenomic Atlas API ab initio 折叠。
**PDB**: `detail/_esm_structures/CT45A2_esmfold.pdb`

| 指标 | 数值 |
|---|---|
| ESMFold 平均 pLDDT | 0.56 |
| pLDDT > 0.9 | 0.0% |
| pLDDT < 0.5 | 51.9% |
| 残基数 | 189 |
...
- UniProt: https://www.uniprot.org/uniprotkb/Q5DJT8
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q5DJT8
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=CT45A2

### HPA IF 图像

HPA: https://www.proteinatlas.org/ENSG00000271449-CT45A2
