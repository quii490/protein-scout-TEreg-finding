...
## DNAAF9 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | DNAAF9 / C20orf194 |
...
**关键文献**:
1. Interpretable machine learning-based survival prediction and key gene identification in cancer using gene expression and clinical data.. *Translational cancer research*. PMID: 41815166
...
**核心优势**:
1. DNAAF9 — Dynein axonemal assembly factor 9，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=DNAAF9
