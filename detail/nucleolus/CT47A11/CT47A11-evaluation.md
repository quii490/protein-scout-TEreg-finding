...
## CT47A11 (Cancer/testis antigen 47A) 核蛋白评估报告
...
|---|---|
| 基因名 | CT47A11 |
| 蛋白全称 | Cancer/testis antigen 47A |
| UniProt ID | Q5JQC4 |
...
HPA 检索: https://www.proteinatlas.org/search/CT47A11

### HPA IF 图像

HPA: https://www.proteinatlas.org/ENSG00000226929-CT47A11
...
| PMID | Title |
|---|---|
| 21811308 | Epigenetic regulation of the X-chromosomal macrosatellite repeat encoding for the cancer/testis gene CT47. |
| 16382448 | Identification of a new cancer/testis gene family, CT47, among expressed multicopy genes on the human X chromosome. |


### ESMFold 结构预测

**方法**: Meta ESM Metagenomic Atlas API ab initio 折叠。
**PDB**: `detail/_esm_structures/CT47A11_esmfold.pdb`
...
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=CT47A11
