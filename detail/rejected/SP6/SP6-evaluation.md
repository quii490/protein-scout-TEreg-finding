...
|------|------|
| 基因名 | SP6 |
| 蛋白名称 | Sp6 transcription factor | trans-acting transcription factor 6 |
| UniProt ID | Q3SY56 |
| 蛋白大小 | 376 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 961 |
...
**详细理由**: PubMed 发表数 961 篇，超过 100 篇阈值，研究领域过于拥挤
