...
## MTCL3 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | MTCL3 / C6orf174, SOGA3 |
| 蛋白名称 | Microtubule cross-linking factor 3 |
| 蛋白大小 | 947 aa / 103.2 kDa |
| UniProt ID | Q5TF21 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 8/10 | ×1 | 8 | 947 aa / 103.2 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 6/10 | ×3 | 18 | AlphaFold v6 pLDDT=64.3; PDB: 无 |
| 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR049885, IPR027881; Pfam: PF11365 |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: C6orf174, SOGA3 |
...
**评价**: AlphaFold 预测质量有限（pLDDT=64.3），有序残基占 45.0%。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR049885, IPR027881; Pfam: PF11365 |
...
| ZNF214 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:28514442|doi:10.1038/na |
...
**核心优势**:
1. MTCL3 — Microtubule cross-linking factor 3，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q5TF21
- Protein Atlas: https://www.proteinatlas.org/search/MTCL3
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=MTCL3
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q5TF21
...
![](https://alphafold.ebi.ac.uk/files/AF-Q5TF21-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
