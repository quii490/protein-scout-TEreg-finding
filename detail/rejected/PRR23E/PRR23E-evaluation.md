...
## PRR23E — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | PRR23E / C3orf56 |
| 蛋白名称 | Proline-rich protein 23E |
| 蛋白大小 | 242 aa / 26.0 kDa |
| UniProt ID | Q8N813 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 242 aa / 26.0 kDa |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: C3orf56 |
...
| 有序区域 (pLDDT>70) 占比 | 5.0% |
| 可用 PDB 条目 | 无 |

**PAE 图像说明**: AlphaFold PAE 图像已重新获取并嵌入（见下方 PAE 图像修正块）；结构判断仍结合 pLDDT 与 PAE 综合判断。

**评价**: AlphaFold 预测质量有限（pLDDT=46.9），有序残基占 5.0%。
...
**核心优势**:
1. PRR23E — Proline-rich protein 23E，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q8N813
- Protein Atlas: https://www.proteinatlas.org/search/PRR23E
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=PRR23E
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q8N813
...
![](https://alphafold.ebi.ac.uk/files/AF-Q8N813-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
