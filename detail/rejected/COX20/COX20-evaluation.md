...
## COX20 — REJECTED (核定位证据不足 (核定位得分 2/10 <= 3))
...
|------|------|
| 基因名 / 别名 | COX20 / FAM36A |
| 蛋白名称 | Cytochrome c oxidase assembly protein COX20, mitochondrial |
| 蛋白大小 | 118 aa / 13.3 kDa |
| UniProt ID | Q5RI15 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 8/10 | x1 | 8 | 118 aa / 13.3 kDa |
| 研究新颖性 | 10/10 | x5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 6/10 | x3 | 18 | AlphaFold v6 pLDDT=65.9; PDB: 无 |
| 调控结构域 | 7/10 | x2 | 14 | InterPro: IPR022533; Pfam: PF12597 |
...
**评价**: AlphaFold 预测质量有限（pLDDT=65.9），有序残基占 46.6%。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR022533; Pfam: PF12597 |
...
**核心优势**:
1. COX20 -- Cytochrome c oxidase assembly protein COX20, mitochondrial，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=COX20
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q5RI15
...
![](https://alphafold.ebi.ac.uk/files/AF-Q5RI15-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
