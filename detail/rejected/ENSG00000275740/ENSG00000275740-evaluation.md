...
gene: "ENSG00000275740"
date: 2026-06-28
tags: [protein-scout, rejected, uncharacterized-accession]
status: rejected
---

## ENSG00000275740 — 自动拒绝

### 拒绝原因

ENSG00000275740 为 UniProtKB 未审查条目（非 reviewed Swiss-Prot 条目）的 accession number，而非标准人类基因符号。该条目在 `unclassified_core_nuclear` sheet 中缺乏核心证据：
