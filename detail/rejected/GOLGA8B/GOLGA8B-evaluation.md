...
## GOLGA8B — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8B |
| 蛋白名称 | Golgin subfamily A member 8B |
| 蛋白大小 | 603 aa / 67.3 kDa |
| UniProt ID | A8MQT2 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 603 aa / 67.3 kDa |
...
**评价**: AlphaFold 预测质量有限（pLDDT=68.5），有序残基占 55.6%。
...
| ENST00000342314 | psi-mi:"MI:2195"(clash) | pubmed:23622248|imex:IM-30030| |
...
**核心优势**:
1. GOLGA8B — Golgin subfamily A member 8B，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A8MQT2
- Protein Atlas: https://www.proteinatlas.org/ENSG00000215252-GOLGA8B/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A8MQT2
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Golgi apparatus (approved)。来源: https://www.proteinatlas.org/ENSG00000215252-GOLGA8B/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-A8MQT2-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
