...
## Fam209 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 2/10 | ×4 | 8 | HPA: Plasma membrane, Cell Junctions; UniProt: 暂无数据（UniProt获取失败） |
...
| 来源 | 定位 | 可信度 |
|------|------|--------|
| Protein Atlas (IF) | Plasma membrane, Cell Junctions | Uncertain |
...
**关键文献**:
1. FAM209 associates with DPY19L2, and is required for sperm acrosome biogenesis and fertility in mice.. *Journal of cell science*. PMID: 34471926
2. Disruption in CYLC1 leads to acrosome detachment, sperm head deformity, and male in/subfertility in humans and mice.. *eLife*. PMID: 38573307
...
| 定位 | UniProt + HPA | 暂无数据（UniProt获取失败） / Plasma membrane, Cell Junctions | 待确认 |
...
**核心优势**:
1. Fam209 — Fam209 (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Fam209
- Protein Atlas: https://www.proteinatlas.org/ENSG00000124103-FAM209A/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Fam209
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Fam209
