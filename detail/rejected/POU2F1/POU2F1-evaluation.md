...
|------|------|
| 基因名 | POU2F1 |
| 蛋白名称 | POU class 2 homeobox 1 | POU domain, class 2, transcription factor 1 |
| UniProt ID | P14859 |
| 蛋白大小 | 743 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 155 |
...
**详细理由**: PubMed 发表数 155 篇，超过 100 篇阈值，研究领域过于拥挤
