...
## Isoc2a — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**核心优势**:
1. Isoc2a — Isoc2a (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Isoc2a
- Protein Atlas: https://www.proteinatlas.org/search/Isoc2a
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Isoc2a
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Isoc2a
