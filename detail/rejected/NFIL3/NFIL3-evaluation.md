...
|------|------|
| 基因名 | NFIL3 |
| 蛋白名称 | nuclear factor, interleukin 3 regulated | nuclear factor, interleukin 3, regulated |
| UniProt ID | Q16649 |
| 蛋白大小 | 462 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 447 |
...
**详细理由**: PubMed 发表数 447 篇，超过 100 篇阈值，研究领域过于拥挤
