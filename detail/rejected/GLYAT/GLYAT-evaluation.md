...
## GLYAT — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | GLYAT / ACGNAT, CAT, GAT |
| 蛋白名称 | Glycine N-acyltransferase |
| 蛋白大小 | 296 aa / 33.9 kDa |
| UniProt ID | Q6IB77 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 296 aa / 33.9 kDa |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=95.6，有序区 100.0%），结构可靠。
...
| Partner | 方法 | PMID |
|---------|------|------|
| Dmel\CG15482 | psi-mi:"MI:1112"(two hybrid prey pooling approach) | pubmed:37061542|imex:IM-28761 |
...
| KRTAP10-8 | psi-mi:"MI:0397"(two hybrid array) | imex:IM-23318|pubmed:25416956 |
...
**核心优势**:
1. GLYAT — Glycine N-acyltransferase，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q6IB77
- Protein Atlas: https://www.proteinatlas.org/ENSG00000149124-GLYAT/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GLYAT
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q6IB77
...
![](https://alphafold.ebi.ac.uk/files/AF-Q6IB77-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
