...
| 蛋白大小 | 3/10 | ×1 | 3 | |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict count |
...
## Gate 2 blocker: Nuclear evidence recheck (2026-06-03)

Packet data analysis (fresh harvest) vs report claims:

| Source | Report claim | Packet actual | Supports nuclear? |
|---|---|---|---|
...
**Decision**: Accept validator recommendation. ABTB3 nuclear evidence ≤3, should be rejected per standard rules. HPA localization claim in original report could not be verified from packet data.

**Exception type**: VALIDATOR_CORRECT — nuclear evidence is genuinely weak  
**Manual review**: required — verify HPA data independently; if HPA Nucleoplasm is confirmed, re-evaluate
