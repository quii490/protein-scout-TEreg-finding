...
## Obox8 — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**关键文献**:
1. OBOX regulates mouse zygotic genome activation and early development.. *Nature*. PMID: 37459895
...
**核心优势**:
1. Obox8 — Obox8 (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Obox8
- Protein Atlas: https://www.proteinatlas.org/search/Obox8
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Obox8
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Obox8
