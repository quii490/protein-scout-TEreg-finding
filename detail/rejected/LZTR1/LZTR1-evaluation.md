...
| 蛋白大小 | 840 aa |
| UniProt ID | Q8N653 |
| 原始定位提示 | Cytoplasm (Tier1) — BTB-Kelch |
| 评估日期 | 2026-05-30 |
...
| 维度 | 数值 | 判定 |
|---|---|---|
| PubMed 总数 (max) | 203 | **>100 → 淘汰** |
| PubMed 总数 (sum) | 203 | — |

**淘汰原因**: 研究新颖性不达标。PubMed 发表数 203 篇 > 100 篇阈值，该蛋白已被广泛研究，不符合「寻找新颖核蛋白」的核心目标。
...
- LZTR1 在 Cytoplasm (Tier1) — BTB-Kelch
...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000099949-LZTR1/subcellular

![](https://images.proteinatlas.org/67852/1277_C10_1_red_green.jpg)
![](https://images.proteinatlas.org/67852/1277_C10_2_red_green.jpg)
![](https://images.proteinatlas.org/67852/1285_C3_2_red_green.jpg)
![](https://images.proteinatlas.org/67852/1285_C3_3_red_green.jpg)
![](https://images.proteinatlas.org/67852/1866_G5_33_red_green.jpg)
![](https://images.proteinatlas.org/67852/1866_G5_35_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->
