...
## GNGT2 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | GNGT2 / GNG8, GNG9, GNGT8 |
...
**核心优势**:
1. GNGT2 — Guanine nucleotide-binding protein G(I)/G(S)/G(O) subunit gamma-T2，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- Protein Atlas: https://www.proteinatlas.org/ENSG00000167083-GNGT2/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GNGT2
...
![](https://alphafold.ebi.ac.uk/files/AF-O14610-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
