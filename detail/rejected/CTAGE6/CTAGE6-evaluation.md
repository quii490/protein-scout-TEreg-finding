...
## CTAGE6 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | CTAGE6 / CTAGE6P |
| 蛋白名称 | cTAGE family member 6 |
| 蛋白大小 | 777 aa / 87.9 kDa |
| UniProt ID | Q86UF2 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 777 aa / 87.9 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 6/10 | ×3 | 18 | AlphaFold v6 pLDDT=68.7; PDB: 无 |
| 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR051500 |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: CTAGE6P |
...
**评价**: AlphaFold 预测质量有限（pLDDT=68.7），有序残基占 54.0%。
...
| ECEL1 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
...
**核心优势**:
1. CTAGE6 — cTAGE family member 6，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q86UF2
- Protein Atlas: https://www.proteinatlas.org/ENSG00000271321-CTAGE6/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=CTAGE6
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q86UF2
...
![](https://alphafold.ebi.ac.uk/files/AF-Q86UF2-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
