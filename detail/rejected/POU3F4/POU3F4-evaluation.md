...
|------|------|
| 基因名 | POU3F4 |
| 蛋白名称 | POU class 3 homeobox 4 | POU domain, class 3, transcription factor 4 |
| UniProt ID | P49335 |
| 蛋白大小 | 361 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 298 |
...
**详细理由**: PubMed 发表数 298 篇，超过 100 篇阈值，研究领域过于拥挤
