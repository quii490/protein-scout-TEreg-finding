...
## GIMD1 — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GIMD1 |
| 蛋白名称 | GTPase IMAP family member GIMD1 |
| 蛋白大小 | 217 aa / 24.5 kDa |
| UniProt ID | P0DJR0 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 217 aa / 24.5 kDa |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=93.5，有序区 97.2%），结构可靠。
...
**核心优势**:
1. GIMD1 — GTPase IMAP family member GIMD1，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P0DJR0
- Protein Atlas: https://www.proteinatlas.org/ENSG00000250298-GIMD1/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GIMD1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P0DJR0
...
![](https://alphafold.ebi.ac.uk/files/AF-P0DJR0-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
