...
## AQP7B — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | AQP7B |
| 蛋白名称 | Putative aquaporin-7B |
| 蛋白大小 | 346 aa / 38.0 kDa |
| UniProt ID | A0A075B734 |
| 评估日期 | 2026-06-03 |
...
| 三维结构 | 7/10 | ×3 | 21 | AlphaFold v6 pLDDT=82.5; PDB: 无 |
| 调控结构域 | 8/10 | ×2 | 16 | InterPro: IPR023271, IPR000425, IPR050363; Pfam: PF00230 |
...
| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR023271, IPR000425, IPR050363; Pfam: PF00230 |
...
| 维度 | 来源 | 结果 | 是否一致 |
|------|------|------|----------|
| 三维结构 | AlphaFold pLDDT=82.5 + PDB: 无 | pLDDT=82.5, v6 | 仅预测 |
...
**核心优势**:
1. AQP7B — Putative aquaporin-7B，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A0A075B734
- Protein Atlas: https://www.proteinatlas.org/search/AQP7B
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=AQP7B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A0A075B734
