...
## GPR6 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GPR6 |
| 蛋白名称 | G-protein coupled receptor 6 |
| 蛋白大小 | 362 aa / 37.9 kDa |
| UniProt ID | P46095 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 362 aa / 37.9 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 9/10 | ×3 | 27 | AlphaFold v6 pLDDT=77.6; PDB: 8T1V, 8T1W, 8TF5, 8TYW |
| 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR000276, IPR017452, IPR001151, IPR000723; Pfam:  |
...
| 可用 PDB 条目 | 8T1V, 8T1W, 8TF5, 8TYW |

**PAE 图像说明**: AlphaFold PAE 图像已重新获取并嵌入（见下方 PAE 图像修正块）；结构判断仍结合 pLDDT 与 PAE 综合判断。

**评价**: PDB实验结构（8T1V, 8T1W, 8TF5, 8TYW）+ AlphaFold高质量预测（pLDDT=77.6），结构可信度高。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR000276, IPR017452, IPR001151, IPR000723; Pfam: PF00001 |
...
| PTPN3 | psi-mi:"MI:2437"(holdup assay) | doi:10.1038/s41467-022-33018-0 |
...
| 维度 | 来源 | 结果 | 是否一致 |
|------|------|------|----------|
| 三维结构 | AlphaFold pLDDT=77.6 + PDB: 8T1V, 8T1W, 8TF5, 8TYW | pLDDT=77.6, v6 | 预测+实验 |
...
**核心优势**:
1. GPR6 — G-protein coupled receptor 6，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P46095
- Protein Atlas: https://www.proteinatlas.org/ENSG00000146360-GPR6/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GPR6
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P46095
...
![](https://alphafold.ebi.ac.uk/files/AF-P46095-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
