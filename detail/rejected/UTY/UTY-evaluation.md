...
|------|------|
| 基因名 | UTY |
| 蛋白名称 | ubiquitously transcribed tetratricopeptide repeat containing, Y-linked |
| UniProt ID | O14607 |
| 蛋白大小 | 1347 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 173 |
...
**详细理由**: PubMed 发表数 173 篇，超过 100 篇阈值，研究领域过于拥挤
