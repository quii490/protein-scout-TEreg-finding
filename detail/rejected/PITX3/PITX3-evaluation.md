...
|------|------|
| 基因名 | PITX3 |
| 蛋白名称 | paired like homeodomain 3 | paired-like homeodomain transcription factor 3 |
| UniProt ID | O75364 |
| 蛋白大小 | 302 aa |
| 核定位分数 | 4 |
| PubMed 总数 | 750 |
...
**详细理由**: PubMed 发表数 750 篇，超过 100 篇阈值，研究领域过于拥挤
