...
## GOLGA8K — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8K |
| 蛋白名称 | Golgin subfamily A member 8K |
...
**评价**: AlphaFold 预测质量有限（pLDDT=68.5），有序残基占 54.2%。
...
**核心优势**:
1. GOLGA8K — Golgin subfamily A member 8K，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/D6RF30
- Protein Atlas: https://www.proteinatlas.org/ENSG00000249931-GOLGA8K/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8K
- AlphaFold: https://alphafold.ebi.ac.uk/entry/D6RF30
...
![](https://alphafold.ebi.ac.uk/files/AF-D6RF30-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
