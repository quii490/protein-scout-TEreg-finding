...
## merged_symbol — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | merged_symbol |
| 蛋白名称 | merged_symbol (UniProt未获取) |
| 蛋白大小 | 未知 aa / 未知 kDa |
| UniProt ID | merged_symbol |
| 评估日期 | 2026-06-03 |
...
**核心优势**:
1. merged_symbol — merged_symbol (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/merged_symbol
- Protein Atlas: https://www.proteinatlas.org/search/merged_symbol
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=merged_symbol
- AlphaFold: https://alphafold.ebi.ac.uk/entry/merged_symbol
