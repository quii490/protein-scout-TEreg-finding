...
|------|------|
| 基因名 | POU4F2 |
| 蛋白名称 | POU class 4 homeobox 2 | POU domain, class 4, transcription factor 2 |
| UniProt ID | Q12837 |
| 蛋白大小 | 409 aa |
| 核定位分数 | 4 |
| PubMed 总数 | 185 |
...
**详细理由**: PubMed 发表数 185 篇，超过 100 篇阈值，研究领域过于拥挤
