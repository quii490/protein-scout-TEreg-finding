...
## GNG5 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GNG5 / GNGT5 |
| 蛋白名称 | Guanine nucleotide-binding protein G(I)/G(S)/G(O) subunit gamma-5 |
| 蛋白大小 | 68 aa / 7.3 kDa |
| UniProt ID | P63218 |
| 评估日期 | 2026-06-03 |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=88.7，有序区 88.2%），结构可靠。
...
| IER3IP1 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:28514442|doi:10.1038/na |
...
**核心优势**:
1. GNG5 — Guanine nucleotide-binding protein G(I)/G(S)/G(O) subunit gamma-5，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P63218
- Protein Atlas: https://www.proteinatlas.org/ENSG00000174021-GNG5/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GNG5
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P63218
...
![](https://alphafold.ebi.ac.uk/files/AF-P63218-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
