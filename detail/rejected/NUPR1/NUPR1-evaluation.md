...
|------|------|
| 基因名 | NUPR1 |
| 蛋白名称 | nuclear protein 1, transcriptional regulator | nuclear protein transcription regulator 1 |
| UniProt ID | O60356 |
| 蛋白大小 | 82 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 316 |
...
**详细理由**: PubMed 发表数 316 篇，超过 100 篇阈值，研究领域过于拥挤
