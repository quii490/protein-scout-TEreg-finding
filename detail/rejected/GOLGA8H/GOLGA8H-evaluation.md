...
## GOLGA8H — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8H |
| 蛋白名称 | Golgin subfamily A member 8H |
| 蛋白大小 | 632 aa / 71.3 kDa |
| UniProt ID | P0CJ92 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 632 aa / 71.3 kDa |
...
**评价**: AlphaFold 预测质量有限（pLDDT=67.8），有序残基占 52.5%。
...
**核心优势**:
1. GOLGA8H — Golgin subfamily A member 8H，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P0CJ92
- Protein Atlas: https://www.proteinatlas.org/ENSG00000261794-GOLGA8H/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8H
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P0CJ92
...
![](https://alphafold.ebi.ac.uk/files/AF-P0CJ92-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
