...
## GP1BB — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GP1BB |
| 蛋白名称 | Platelet glycoprotein Ib beta chain |
| 蛋白大小 | 206 aa / 21.7 kDa |
| UniProt ID | P13224 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 206 aa / 21.7 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 9/10 | ×3 | 27 | AlphaFold v6 pLDDT=88.0; PDB: 3REZ, 3RFE, 8WFS |
| 调控结构域 | 8/10 | ×2 | 16 | InterPro: IPR000483, IPR052313, IPR032675, IPR000372 |
...
| 高置信度残基 (pLDDT>90) 占比 | 71.4% |
| 置信残基 (pLDDT 70-90) 占比 | 9.7% |
| 中等置信 (pLDDT 50-70) 占比 | 18.0% |
| 低置信 (pLDDT<50) 占比 | 1.0% |
| 有序区域 (pLDDT>70) 占比 | 81.1% |
| 可用 PDB 条目 | 3REZ, 3RFE, 8WFS |

**PAE 图像说明**: AlphaFold PAE 图像已重新获取并嵌入（见下方 PAE 图像修正块）；结构判断仍结合 pLDDT 与 PAE 综合判断。

**评价**: PDB实验结构（3REZ, 3RFE, 8WFS）+ AlphaFold高质量预测（pLDDT=88.0），结构可信度高。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR000483, IPR052313, IPR032675, IPR000372 |
...
| Partner | 方法 | PMID |
|---------|------|------|
| ENSP00000383382.2 | psi-mi:"MI:0370"(tox-r dimerization assay) | pubmed:18674540|imex:IM-24276 |
...
| 维度 | 来源 | 结果 | 是否一致 |
|------|------|------|----------|
| 三维结构 | AlphaFold pLDDT=88.0 + PDB: 3REZ, 3RFE, 8WFS | pLDDT=88.0, v6 | 预测+实验 |
...
**核心优势**:
1. GP1BB — Platelet glycoprotein Ib beta chain，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P13224
- Protein Atlas: https://www.proteinatlas.org/ENSG00000203618-GP1BB/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GP1BB
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P13224
...
![](https://alphafold.ebi.ac.uk/files/AF-P13224-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
