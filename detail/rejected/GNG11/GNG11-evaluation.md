...
## GNG11 — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GNG11 / GNGT11 |
| 蛋白名称 | Guanine nucleotide-binding protein G(I)/G(S)/G(O) subunit gamma-11 |
| 蛋白大小 | 73 aa / 8.5 kDa |
| UniProt ID | P61952 |
| 评估日期 | 2026-06-03 |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=88.1，有序区 94.6%），结构可靠。
...
| SMURF1 | psi-mi:"MI:0813"(proximity ligation assay) | pubmed:25241761|imex:IM-18707 |
| PDCL | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:28514442|doi:10.1038/na |
| CEP44 | psi-mi:"MI:0397"(two hybrid array) | pubmed:32296183|imex:IM-25472 |
| REP15 | psi-mi:"MI:1112"(two hybrid prey pooling approach) | pubmed:32296183|imex:IM-25472 |
...
| FOS | psi-mi:"MI:0397"(two hybrid array) | imex:IM-23318|pubmed:25416956 |
...
**核心优势**:
1. GNG11 — Guanine nucleotide-binding protein G(I)/G(S)/G(O) subunit gamma-11，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P61952
- Protein Atlas: https://www.proteinatlas.org/ENSG00000127920-GNG11/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GNG11
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P61952
...
![](https://alphafold.ebi.ac.uk/files/AF-P61952-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
