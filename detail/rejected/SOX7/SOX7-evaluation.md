...
|------|------|
| 基因名 | SOX7 |
| 蛋白名称 | SRY-box transcription factor 7 | SRY (sex determining region Y)-box 7 |
| UniProt ID | Q9BT81 |
| 蛋白大小 | 388 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 233 |
...
**详细理由**: PubMed 发表数 233 篇，超过 100 篇阈值，研究领域过于拥挤
