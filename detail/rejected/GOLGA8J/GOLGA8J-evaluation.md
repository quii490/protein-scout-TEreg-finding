...
## GOLGA8J — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8J |
| 蛋白名称 | Golgin subfamily A member 8J |
| 蛋白大小 | 632 aa / 71.8 kDa |
| UniProt ID | A6NMD2 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 632 aa / 71.8 kDa |
...
**评价**: AlphaFold 预测质量有限（pLDDT=68.8），有序残基占 54.2%。
...
| Partner | 方法 | PMID |
|---------|------|------|
| GOLGA8G | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
...
**核心优势**:
1. GOLGA8J — Golgin subfamily A member 8J，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A6NMD2
- Protein Atlas: https://www.proteinatlas.org/ENSG00000179938-GOLGA8J/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8J
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A6NMD2
...
![](https://alphafold.ebi.ac.uk/files/AF-A6NMD2-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
