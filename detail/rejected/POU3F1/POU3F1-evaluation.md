...
|------|------|
| 基因名 | POU3F1 |
| 蛋白名称 | POU class 3 homeobox 1 | POU domain, class 3, transcription factor 1 |
| UniProt ID | Q03052 |
| 蛋白大小 | 451 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 147 |
...
**详细理由**: PubMed 发表数 147 篇，超过 100 篇阈值，研究领域过于拥挤
