...
## Mfap1a — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**核心优势**:
1. Mfap1a — Mfap1a (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Mfap1a
- Protein Atlas: https://www.proteinatlas.org/search/Mfap1a
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Mfap1a
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Mfap1a
