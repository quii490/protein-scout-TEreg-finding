...
## FAM153C — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**关键文献**:
1. Differential Genes Expression between Fertile and Infertile Spermatozoa Revealed by Transcriptome Analysis.. *PloS one*. PMID: 25973848
...
**核心优势**:
1. FAM153C — FAM153C (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/FAM153C
- Protein Atlas: https://www.proteinatlas.org/search/FAM153C
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FAM153C
- AlphaFold: https://alphafold.ebi.ac.uk/entry/FAM153C
