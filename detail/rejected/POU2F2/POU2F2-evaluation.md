...
|------|------|
| 基因名 | POU2F2 |
| 蛋白名称 | POU class 2 homeobox 2 | POU domain, class 2, transcription factor 2 |
| UniProt ID | P09086 |
| 蛋白大小 | 479 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 799 |
...
**详细理由**: PubMed 发表数 799 篇，超过 100 篇阈值，研究领域过于拥挤
