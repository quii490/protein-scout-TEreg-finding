...
|------|------|
| 基因名 | POU4F1 |
| 蛋白名称 | POU class 4 homeobox 1 | POU domain, class 4, transcription factor 1 |
| UniProt ID | Q01851 |
| 蛋白大小 | 419 aa |
| 核定位分数 | 4 |
| PubMed 总数 | 267 |
...
**详细理由**: PubMed 发表数 267 篇，超过 100 篇阈值，研究领域过于拥挤
