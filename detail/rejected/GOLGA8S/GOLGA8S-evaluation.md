...
## GOLGA8S — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8S |
| 蛋白名称 | Golgin subfamily A member 8S |
| 蛋白大小 | 638 aa / 71.9 kDa |
| UniProt ID | H3BPF8 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 638 aa / 71.9 kDa |
...
**评价**: AlphaFold 预测质量有限（pLDDT=67.9），有序残基占 52.3%。
...
**核心优势**:
1. GOLGA8S — Golgin subfamily A member 8S，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/H3BPF8
- Protein Atlas: https://www.proteinatlas.org/ENSG00000261739-GOLGA8S/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8S
- AlphaFold: https://alphafold.ebi.ac.uk/entry/H3BPF8
...
![](https://alphafold.ebi.ac.uk/files/AF-H3BPF8-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
