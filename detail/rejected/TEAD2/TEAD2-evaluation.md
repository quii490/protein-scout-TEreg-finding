...
|------|------|
| 基因名 | TEAD2 |
| 蛋白名称 | TEA domain transcription factor 2 | TEA domain family member 2 |
| UniProt ID | Q15562 |
| 蛋白大小 | 447 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 136 |
...
**详细理由**: PubMed 发表数 136 篇，超过 100 篇阈值，研究领域过于拥挤
