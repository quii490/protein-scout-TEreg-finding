...
**核心原因: 数据不可用。ANKDD1B 的harvest packet JSON文件在 protein_data/harvest_packets/ 目录中不存在，无法从自动化pipeline获取UniProt、AlphaFold、PubMed、STRING、IntAct、HPA等必需数据库信息。**


**备注**: ANKDD1B (ankyrin repeat and death domain containing 1B) 含有ankyrin repeat结构域和death domain，可能参与凋亡信号调控。目前缺乏数据库记录，可能是未被充分注释的新基因产物或假基因。
...
1. 确认 ANKDD1B 的当前HGNC官方符号，如有变更重新运行harvest
...
ANKDD1B 因harvest packet数据缺失，无法完成标准六维蛋白评估。在获得完整数据之前，**维持拒绝状态**。如后续补充packet数据或确认该基因的数据库记录状态，可重新进行完整评估。

![[Projects/TEreg-finding/protein-interested/detail/rejected/ANKDD1B/ANKDD1B-PAE.png]]
