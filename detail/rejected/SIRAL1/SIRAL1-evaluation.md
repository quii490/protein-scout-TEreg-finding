...
## SIRAL1 — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**核心优势**:
1. SIRAL1 — SIRAL1 (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/SIRAL1
- Protein Atlas: https://www.proteinatlas.org/search/SIRAL1
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=SIRAL1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/SIRAL1
