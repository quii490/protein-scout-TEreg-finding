...
## Nat8f3 — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**核心优势**:
1. Nat8f3 — Nat8f3 (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Nat8f3
- Protein Atlas: https://www.proteinatlas.org/search/Nat8f3
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Nat8f3
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Nat8f3
