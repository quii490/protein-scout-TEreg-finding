...
|------|------|
| 基因名 | NET1 |
| 蛋白名称 | neuroepithelial cell transforming 1 | neuroepithelial cell transforming gene 1 |
| UniProt ID | Q7Z628 |
| 蛋白大小 | 596 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 216 |
...
**详细理由**: PubMed 发表数 216 篇，超过 100 篇阈值，研究领域过于拥挤
