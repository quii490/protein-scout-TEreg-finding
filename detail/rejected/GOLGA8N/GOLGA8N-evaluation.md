...
## GOLGA8N — REJECTED (核定位证据不足 (核定位得分 2/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | GOLGA8N |
| 蛋白名称 | Golgin subfamily A member 8N |
...
**关键文献**:
1. Integration of bioinformatics and machine learning approaches for the validation of pyrimidine metabolism-related genes and their implications in immunotherapy for osteoporosis.. *BMC musculoskeletal disorders*. PMID: 38778304
2. Bioinformatics and machine learning were used to validate glutamine metabolism-related genes and immunotherapy in osteoporosis patients.. *Journal of orthopaedic surgery and research*. PMID: 37710308
...
| MTMR10 | 0.563 | 0.000 | — |
| GTF3C6 | 0.518 | 0.000 | — |
| CCDC144NL | 0.492 | 0.095 | — |
| GOLGB1 | 0.489 | 0.420 | — |
| STX5 | 0.482 | 0.420 | — |
| OTUD7A | 0.474 | 0.000 | — |
| GOSR1 | 0.459 | 0.420 | — |
| GTF3C5 | 0.447 | 0.000 | — |
| GOLGA6L1 | 0.423 | 0.099 | — |
| TRMT5 | 0.412 | 0.051 | — |
...
**核心优势**:
1. GOLGA8N — Golgin subfamily A member 8N，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/F8WBI6
- Protein Atlas: https://www.proteinatlas.org/ENSG00000232653-GOLGA8N/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=GOLGA8N
- AlphaFold: https://alphafold.ebi.ac.uk/entry/F8WBI6
...
![](https://alphafold.ebi.ac.uk/files/AF-F8WBI6-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
