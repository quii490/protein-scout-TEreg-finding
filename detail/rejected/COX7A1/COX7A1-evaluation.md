...
## COX7A1 — REJECTED (核定位证据不足 (核定位得分 2/10 <= 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | COX7A1 / COX7AH |
| 蛋白名称 | Cytochrome c oxidase subunit 7A1, mitochondrial |
| 蛋白大小 | 79 aa / 9.1 kDa |
| UniProt ID | P24310 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 5/10 | x1 | 5 | 79 aa / 9.1 kDa |
| 研究新颖性 | 10/10 | x5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 8/10 | x3 | 24 | AlphaFold v6 pLDDT=88.4; PDB: 无 |
...
**评价**: AlphaFold 极高置信度（pLDDT=88.4，有序区 84.9%）。
...
**核心优势**:
1. COX7A1 -- Cytochrome c oxidase subunit 7A1, mitochondrial，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/P24310
- Protein Atlas: https://www.proteinatlas.org/ENSG00000161281-COX7A1/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=COX7A1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P24310
