...
## TMA7B — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
|------|------|
| 基因名 / 别名 | TMA7B |
| 蛋白名称 | Translation machinery-associated protein 7B |
| 蛋白大小 | 64 aa / 7.1 kDa |
...
**评价**: AlphaFold 中等质量（pLDDT=72.8，有序区 48.4%），结构基本可用。
...
**核心优势**:
1. TMA7B — Translation machinery-associated protein 7B，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A0A024R1R8
- Protein Atlas: https://www.proteinatlas.org/search/TMA7B
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=TMA7B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A0A024R1R8
