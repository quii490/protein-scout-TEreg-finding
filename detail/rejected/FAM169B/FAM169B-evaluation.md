...
## FAM169B — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | FAM169B / FAM169B, KIAA0888L |
| 蛋白名称 | Protein FAM169BP |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: FAM169B, KIAA0888L |
...
**评价**: AlphaFold 中等质量（pLDDT=70.1，有序区 53.7%），结构基本可用。
...
| Partner | 方法 | PMID |
|---------|------|------|
| FAM169BP | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
...
**核心优势**:
1. FAM169B — Protein FAM169BP，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q8N8A8
- Protein Atlas: https://www.proteinatlas.org/search/FAM169B
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FAM169B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q8N8A8
