...
|------|------|
| 基因名 | TCF7L1 |
| 蛋白名称 | transcription factor 7 like 1 | transcription factor 7 like 1 (T cell specific, HMG box) |
| UniProt ID | Q9HCS4 |
| 蛋白大小 | 588 aa |
| 核定位分数 | 6 |
| PubMed 总数 | 297 |
...
**详细理由**: PubMed 发表数 297 篇，超过 100 篇阈值，研究领域过于拥挤
