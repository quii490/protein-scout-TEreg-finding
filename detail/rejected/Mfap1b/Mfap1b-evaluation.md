...
## Mfap1b — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))
...
**核心优势**:
1. Mfap1b — Mfap1b (UniProt未获取)，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Mfap1b
- Protein Atlas: https://www.proteinatlas.org/search/Mfap1b
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=Mfap1b
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Mfap1b
