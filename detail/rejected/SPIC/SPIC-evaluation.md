...
|------|------|
| 基因名 | SPIC |
| 蛋白名称 | Spi-C transcription factor | Spi-C transcription factor (Spi-1/PU.1 related) |
| UniProt ID | Q8N5J4 |
| 蛋白大小 | 248 aa |
| 核定位分数 | 4 |
| PubMed 总数 | 140 |
...
**详细理由**: PubMed 发表数 140 篇，超过 100 篇阈值，研究领域过于拥挤
