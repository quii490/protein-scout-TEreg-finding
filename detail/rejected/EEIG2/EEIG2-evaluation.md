...
## EEIG2 — REJECTED (核定位证据不足 (核定位得分 3/10 ≤ 3))

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | EEIG2 / FAM102B |
...
**核心优势**:
1. EEIG2 — EEIG family member 2，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- Protein Atlas: https://www.proteinatlas.org/search/EEIG2
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=EEIG2
...
![](https://alphafold.ebi.ac.uk/files/AF-Q5T8I3-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
