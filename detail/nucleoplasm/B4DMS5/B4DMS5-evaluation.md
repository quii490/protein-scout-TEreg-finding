...
## B4DMS5 (KRR-R motif-containing protein 1) 核蛋白评估报告
...
|---|---|
| 基因名 | B4DMS5 |
| 蛋白名称 | KRR-R motif-containing protein 1 |
| UniProt ID | B4DMS5 |
| 蛋白大小 | 177 aa |
| 评估日期 | 2026-06-29 |
...
**蛋白全称**: KRR-R motif-containing protein 1
...
HPA 检索: https://www.proteinatlas.org/search/B4DMS5

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B4DMS5
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B4DMS5
