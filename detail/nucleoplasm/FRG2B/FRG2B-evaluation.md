...
## FRG2B 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | FRG2B |
| 蛋白名称 | Protein FRG2-like-1 |
| 蛋白大小 | 278 aa / 30.6 kDa |
| UniProt ID | Q96QU4 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 278 aa / 30.6 kDa |
...
**评价**: AlphaFold 预测质量有限（pLDDT=60.4），有序残基占 23.8%。
...
|---------|---------------|--------------|---------|
| OR4L1 | 0.573 | 0.000 | — |
| KRTAP10-1 | 0.523 | 0.000 | — |
| CCDC89 | 0.507 | 0.000 | — |
| POMZP3 | 0.474 | 0.000 | — |
| KRTAP4-3 | 0.447 | 0.000 | — |
| ZNF557 | 0.433 | 0.000 | — |
| KIAA1671 | 0.432 | 0.000 | — |
| FAM171B | 0.430 | 0.000 | — |
| XKR3 | 0.420 | 0.000 | — |
| HRCT1 | 0.418 | 0.000 | — |
...
**核心优势**:
1. FRG2B — Protein FRG2-like-1，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
