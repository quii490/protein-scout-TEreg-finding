...
## B3KVM5 (cDNA FLJ16751 fis, clone BEAST2001444, highly similar to Orphan nuclear receptor PXR) 核蛋白评估报告
...
|---|---|
| 基因名 | B3KVM5 |
| 蛋白名称 | cDNA FLJ16751 fis, clone BEAST2001444, highly similar to Orphan nuclear receptor PXR |
| UniProt ID | B3KVM5 |
| 蛋白大小 | 322 aa |
| 评估日期 | 2026-06-29 |
...
**PDB 文件**: `detail/_esm_structures/B3KVM5_esmfold.pdb`
...
HPA 检索: https://www.proteinatlas.org/search/B3KVM5

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B3KVM5
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B3KVM5
