...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000183765-CHEK2/subcellular

![](https://images.proteinatlas.org/1878/1144_D3_1_red_green.jpg)
![](https://images.proteinatlas.org/1878/1144_D3_3_red_green.jpg)
![](https://images.proteinatlas.org/1878/51_C12_1_red_green.jpg)
![](https://images.proteinatlas.org/1878/51_C12_2_red_green.jpg)
![](https://images.proteinatlas.org/1878/934_H11_1_red_green.jpg)
![](https://images.proteinatlas.org/1878/934_H11_2_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-O96017-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt Domain [FT] | DOMAIN 113..175; /note="FHA"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00086"; DOMAIN 220..486; /note="Protein kinase"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00159" |
| InterPro | IPR000253;IPR011009;IPR000719;IPR008271;IPR008984; |
| Pfam | PF00498;PF00069; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000183765-CHEK2/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| AATF | Intact, Biogrid | true |
| CDC25A | Intact, Biogrid | true |
| IL24 | Intact, Biogrid | true |
| KPNA2 | Intact, Biogrid | true |
| LRATD2 | Intact, Biogrid | true |
| MDM2 | Intact, Biogrid | true |
| PLK1 | Intact, Biogrid | true |
| PPM1G | Intact, Biogrid | true |
