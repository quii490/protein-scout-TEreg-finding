...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000151364-KCTD14/subcellular

![](https://images.proteinatlas.org/41118/1787_B5_33_red_green.jpg)
![](https://images.proteinatlas.org/41118/1787_B5_34_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q9BQ13-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | Q9BQ13 |
| SMART | SM00225; |
| UniProt Domain [FT] | DOMAIN 33..130; /note="BTB" |
| InterPro | IPR000210;IPR057890;IPR011333;IPR003131; |
| Pfam | PF02214;PF25611; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000151364-KCTD14/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| ACSF3 | Intact | false |
| ANKS1A | Bioplex | false |
| CHUK | Bioplex | false |
| DHFR | Bioplex | false |
