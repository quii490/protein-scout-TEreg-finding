...
## B4DPR1 (cDNA FLJ58518, highly similar to Nuclear receptor ROR-gamma) 核蛋白评估报告
...
|---|---|
| 基因名 | B4DPR1 |
| 蛋白名称 | cDNA FLJ58518, highly similar to Nuclear receptor ROR-gamma |
| UniProt ID | B4DPR1 |
| 蛋白大小 | 572 aa |
| 评估日期 | 2026-06-29 |
...
**蛋白全称**: cDNA FLJ58518, highly similar to Nuclear receptor ROR-gamma
...
HPA 检索: https://www.proteinatlas.org/search/B4DPR1

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B4DPR1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B4DPR1
