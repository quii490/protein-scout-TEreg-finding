...
## DMRTC1B 核蛋白评估报告 (Full Re-evaluation)
...
**核心优势**:
1. DMRTC1B — Doublesex- and mab-3-related transcription factor C1，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- Protein Atlas: https://www.proteinatlas.org/ENSG00000184911-DMRTC1B/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=DMRTC1B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q5HYR2
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000184911-DMRTC1B/subcellular
...
| InterPro | IPR026607;IPR031577; |
| Pfam | PF15791; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000184911-DMRTC1B/interaction
