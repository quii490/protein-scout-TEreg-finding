...
## B4DEE4 (cDNA FLJ53827, highly similar to Speckle-type POZ protein) 核蛋白评估报告
...
|---|---|
| 基因名 | B4DEE4 |
| 蛋白名称 | cDNA FLJ53827, highly similar to Speckle-type POZ protein |
| UniProt ID | B4DEE4 |
| 蛋白大小 | 199 aa |
| 评估日期 | 2026-06-29 |
...
**蛋白全称**: cDNA FLJ53827, highly similar to Speckle-type POZ protein
...
HPA 检索: https://www.proteinatlas.org/search/B4DEE4

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B4DEE4
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B4DEE4
