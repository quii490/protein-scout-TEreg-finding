...
## FOXD4L1 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | FOXD4L1 |
| 蛋白名称 | Forkhead box protein D4-like 1 |
| 蛋白大小 | 408 aa / 43.6 kDa |
| UniProt ID | Q9NU39 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 408 aa / 43.6 kDa |
...
2. On becoming neural: what the embryo can tell us about differentiating neural stem cells.. *American journal of stem cells*. PMID: 23862097
3. Neural transcription factors bias cleavage stage blastomeres to give rise to neural ectoderm.. *Genesis (New York, N.Y. : 2000)*. PMID: 27092474
4. Foxd4l1.1 Negatively Regulates Chordin Transcription in Neuroectoderm of Xenopus Gastrula.. *Cells*. PMID: 34685759
...
**评价**: AlphaFold 预测质量有限（pLDDT=58.1），有序残基占 23.3%。
...
| CARD9 | psi-mi:"MI:1112"(two hybrid prey pooling approach) | pubmed:32296183|imex:IM-25472 |
| HGS | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
| HMG20A | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
| TRIP6 | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
**核心优势**:
1. FOXD4L1 — Forkhead box protein D4-like 1，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q9NU39
- Protein Atlas: https://www.proteinatlas.org/ENSG00000184492-FOXD4L1/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FOXD4L1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q9NU39
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000184492-FOXD4L1/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-Q9NU39-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000184492-FOXD4L1/interaction
