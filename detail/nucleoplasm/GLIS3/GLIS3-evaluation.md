...
## GLIS3 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | GLIS3 / ZNF515 |
| 蛋白名称 | Zinc finger protein GLIS3 |
| 蛋白大小 | 775 aa / 83.6 kDa |
| UniProt ID | Q8NEA6 |
| 评估日期 | 2026-06-03 |
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 9/10 | ×4 | 36 | HPA: Nucleoplasm; 额外: Golgi apparatus, Primary cilium; UniProt: Nucleus |
| 蛋白大小 | 10/10 | ×1 | 10 | 775 aa / 83.6 kDa |
...
| 低置信 (pLDDT<50) 占比 | 70.6% |
| 有序区域 (pLDDT>70) 占比 | 21.3% |
| 可用 PDB 条目 | 无 |

**PAE**: PAE 图像未生成本地文件（standard evaluation），结构判断基于 AlphaFold pLDDT 统计。

**评价**: AlphaFold 预测质量有限（pLDDT=49.1），有序残基占 21.3%。
...
| CIB1 | psi-mi:"MI:0397"(two hybrid array) | pubmed:32296183|imex:IM-25472 |
| NEK6 | psi-mi:"MI:1112"(two hybrid prey pooling approach) | pubmed:32296183|imex:IM-25472 |
| KRTAP6-1 | psi-mi:"MI:1112"(two hybrid prey pooling approach) | pubmed:32296183|imex:IM-25472 |
...
| CLNK | psi-mi:"MI:0397"(two hybrid array) | pubmed:25814554|imex:IM-22632 |
...
| 定位 | UniProt + HPA | Nucleus / Nucleoplasm; 额外: Golgi apparatus, Primary cilium | 一致 |
...
**核心优势**:
1. GLIS3 — Zinc finger protein GLIS3，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
