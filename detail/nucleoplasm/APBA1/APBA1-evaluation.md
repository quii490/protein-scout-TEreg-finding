...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Golgi apparatus (supported)。来源: https://www.proteinatlas.org/ENSG00000107282-APBA1/subcellular

![](https://images.proteinatlas.org/61287/1223_H7_3_blue_red_green.jpg)
![](https://images.proteinatlas.org/61287/1223_H7_4_blue_red_green.jpg)
![](https://images.proteinatlas.org/61287/1599_C6_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/61287/1599_C6_3_blue_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q02410-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
|---|---|
| UniProt | Q02410 |
| SMART | SM00228;SM00462; |
| UniProt Domain [FT] | DOMAIN 457..643; /note="PID"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00148"; DOMAIN 656..742; /note="PDZ 1"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00143"; DOMAIN 747..822; /note="PDZ 2"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00143" |
| InterPro | IPR051230;IPR001478;IPR036034;IPR011993;IPR006020; |
| Pfam | PF00595;PF00640; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000107282-APBA1/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| APP | Intact, Biogrid | true |
| CASK | Intact, Biogrid | true |
| LIN7B | Biogrid, Bioplex | true |
| LIN7C | Biogrid, Bioplex | true |
| CCS | Biogrid | false |
| DLG1 | Biogrid | false |
| KCNJ12 | Biogrid | false |
| LIN7A | Bioplex | false |
