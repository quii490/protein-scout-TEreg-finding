...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000105204-DYRK1B/subcellular

![](https://images.proteinatlas.org/28522/1468_B6_1_red_green.jpg)
![](https://images.proteinatlas.org/28522/1468_B6_4_red_green.jpg)
![](https://images.proteinatlas.org/28522/1656_F4_1_red_green.jpg)
![](https://images.proteinatlas.org/28522/1656_F4_3_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q9Y463-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | Q9Y463 |
| SMART | SM00220; |
| UniProt Domain [FT] | DOMAIN 111..431; /note="Protein kinase"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00159" |
| InterPro | IPR011009;IPR044131;IPR000719;IPR017441;IPR008271;IPR050494; |
| Pfam | PF00069; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000105204-DYRK1B/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| DCAF7 | Intact, Biogrid | true |
| LZTS2 | Intact, Biogrid | true |
| RANBP9 | Intact, Biogrid | true |
| RB1 | Intact, Biogrid | true |
| RBL1 | Intact, Biogrid | true |
| TROAP | Intact, Biogrid | true |
| AKAP11 | Biogrid | false |
| ATAD3B | Biogrid | false |
