...
## B3KUT8 (cDNA FLJ40596 fis, clone THYMU2010831, highly similar to Double-strand-break repair protein rad21 homolog) 核蛋白评估报告
...
|---|---|
| 基因名 | B3KUT8 |
| 蛋白名称 | cDNA FLJ40596 fis, clone THYMU2010831, highly similar to Double-strand-break repair protein rad21 homolog |
| UniProt ID | B3KUT8 |
| 蛋白大小 | 181 aa |
| 评估日期 | 2026-06-29 |
...
**PDB 文件**: `detail/_esm_structures/B3KUT8_esmfold.pdb`
...
HPA 检索: https://www.proteinatlas.org/search/B3KUT8

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B3KUT8
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B3KUT8
