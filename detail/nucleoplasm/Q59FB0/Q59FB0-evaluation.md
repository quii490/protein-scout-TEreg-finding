...
|---|---|
| 基因名 | Q59FB0 |
| 蛋白名称 | PREDICTED: KRAB domain only 2 variant |
| 蛋白大小 | 403 aa / 46.6 kDa |
| UniProt ID | Q59FB0 |
| 评估日期 | 2026-06-28 |
...
**蛋白全称**: PREDICTED: KRAB domain only 2 variant
...
![PAE](https://alphafold.ebi.ac.uk/files/AF-Q59FB0-F1-predicted_aligned_error_v6.png)

### HPA IF 图像

HPA 检索: https://www.proteinatlas.org/search/Q59FB0
