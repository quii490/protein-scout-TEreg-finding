...
## QTMAN 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | QTMAN / GTDC1 |
| 蛋白名称 | tRNA-queuosine alpha-mannosyltransferase |
| 蛋白大小 | 458 aa / 52.6 kDa |
| UniProt ID | Q4AE62 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 458 aa / 52.6 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=2 篇 (≤20→10) |
| 三维结构 | 7/10 | ×3 | 21 | AlphaFold v6 pLDDT=82.3; PDB: 无 |
| 调控结构域 | 8/10 | ×2 | 16 | InterPro: IPR001296, IPR051862, IPR022701; Pfam: PF00534, PF |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: GTDC1 |
...
**评价**: AlphaFold 中等质量（pLDDT=82.3，有序区 78.7%），结构基本可用。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR001296, IPR051862, IPR022701; Pfam: PF00534, PF12038 |
...
**核心优势**:
1. QTMAN — tRNA-queuosine alpha-mannosyltransferase，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q4AE62
- Protein Atlas: https://www.proteinatlas.org/search/QTMAN
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=QTMAN
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q4AE62
...
![](https://alphafold.ebi.ac.uk/files/AF-Q4AE62-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| InterPro | IPR001296;IPR051862;IPR022701; |
