...
HPA 检索: https://www.proteinatlas.org/search/DHRS7
...
| PMID | Title |
|---|---|
| 42342961 | A novel lactylation-related gene signature deciphers the immunosuppressive microenvironment and stratifies precision therapy in colorectal cancer. |
| 41948891 | The acyl- and alkyl-glycerone phosphate reductase DHRS7 is involved in the production of distinct plasmalogen species from DHRS7B. |
| 41522628 | Deciphering immune cell interaction aberrations in necrotizing enterocolitis: the regulatory role of DHRS7. |
| 41088300 | Construction and validation of a lactylation-based gene signature for prognostic assessment and immune infiltration analysis in gastric adenocarcinoma |
| 40907572 | Deep Learning-Based Multimodal Prediction of NAC Response in LARC by Integrating MRI and Proteomics. |
