...
## GLMP 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | GLMP / C1orf85 |
| 蛋白名称 | Glycosylated lysosomal membrane protein |
| 蛋白大小 | 406 aa / 43.9 kDa |
| UniProt ID | Q8WWB7 |
| 评估日期 | 2026-06-03 |
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 4/10 | ×4 | 16 | HPA: 暂无HPA定位数据; UniProt: Lysosome membrane |
| 蛋白大小 | 10/10 | ×1 | 10 | 406 aa / 43.9 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 8/10 | ×3 | 24 | AlphaFold v6 pLDDT=86.4; PDB: 无 |
| 调控结构域 | 8/10 | ×2 | 16 | InterPro: IPR029382; Pfam: PF15065 |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=86.4，有序区 86.5%），结构可靠。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR029382; Pfam: PF15065 |
...
| DHRS9 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:28514442|doi:10.1038/na |
...
**核心优势**:
1. GLMP — Glycosylated lysosomal membrane protein，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
