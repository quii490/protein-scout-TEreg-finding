...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (enhanced)。来源: https://www.proteinatlas.org/ENSG00000075426-FOSL2/subcellular

![](https://images.proteinatlas.org/13460/666_H4_1_red_green.jpg)
![](https://images.proteinatlas.org/13460/666_H4_2_red_green.jpg)
![](https://images.proteinatlas.org/13460/671_H4_1_red_green.jpg)
![](https://images.proteinatlas.org/13460/671_H4_2_red_green.jpg)
![](https://images.proteinatlas.org/4817/118_D2_1_red_green.jpg)
![](https://images.proteinatlas.org/4817/118_D2_2_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-P15408-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | P15408 |
| SMART | SM00338; |
| UniProt Domain [FT] | DOMAIN 124..187; /note="bZIP"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00978" |
| InterPro | IPR000837;IPR004827;IPR046347; |
| Pfam | PF00170; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000075426-FOSL2/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| ATF2 | Intact, Biogrid, Bioplex | true |
| ATF7 | Intact, Biogrid | true |
| BACH2 | Intact, Biogrid | true |
| JUN | Intact, Biogrid, Bioplex | true |
| JUNB | Intact, Biogrid, Bioplex | true |
| JUND | Intact, Biogrid, Bioplex | true |
