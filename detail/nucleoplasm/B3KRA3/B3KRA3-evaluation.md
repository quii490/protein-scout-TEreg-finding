...
## B3KRA3 (cDNA FLJ33923 fis, clone CTONG2017021, highly similar to Homo sapiens hyaluronan binding protein 4 (HABP4), mRNA) 核蛋白评估报告
...
|---|---|
| 基因名 | B3KRA3 |
| 蛋白名称 | cDNA FLJ33923 fis, clone CTONG2017021, highly similar to Homo sapiens hyaluronan binding protein 4 (HABP4), mRNA |
| UniProt ID | B3KRA3 |
| 蛋白大小 | 123 aa |
| 评估日期 | 2026-06-29 |
...
**PDB 文件**: `detail/_esm_structures/B3KRA3_esmfold.pdb`

| 指标 | 数值 |
|---|---|
| ESMFold 平均 pLDDT | 0.51 |
| pLDDT > 0.9 占比 | 0.0% |
| pLDDT < 0.5 占比 | 62.6% |
| 建模残基数 | 123 |
...
HPA 检索: https://www.proteinatlas.org/search/B3KRA3

### 5. 数据来源

- UniProt: https://www.uniprot.org/uniprotkb/B3KRA3
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B3KRA3
