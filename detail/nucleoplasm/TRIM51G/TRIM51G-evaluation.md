...
## TRIM51G 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | TRIM51G / TRIM51GP |
| 蛋白名称 | Tripartite motif-containing protein 51G |
| 蛋白大小 | 452 aa / 53.0 kDa |
| UniProt ID | A0A3B3IT33 |
| 评估日期 | 2026-06-03 |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: TRIM51GP |
...
**评价**: AlphaFold 极高置信度预测（pLDDT=86.9，有序区 88.9%），结构可靠。
...
**核心优势**:
1. TRIM51G — Tripartite motif-containing protein 51G，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A0A3B3IT33
- Protein Atlas: https://www.proteinatlas.org/ENSG00000220948-TRIM51G/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=TRIM51G
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A0A3B3IT33
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Vesicles (approved)。来源: https://www.proteinatlas.org/ENSG00000220948-TRIM51G/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-A0A3B3IT33-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000220948-TRIM51G/interaction
