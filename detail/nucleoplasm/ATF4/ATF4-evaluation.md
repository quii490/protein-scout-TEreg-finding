...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000128272-ATF4/subcellular

![](https://images.proteinatlas.org/62987/1262_F5_2_red_green.jpg)
![](https://images.proteinatlas.org/62987/1262_F5_4_red_green.jpg)
![](https://images.proteinatlas.org/62987/1264_F5_1_red_green.jpg)
![](https://images.proteinatlas.org/62987/1264_F5_6_red_green.jpg)
![](https://images.proteinatlas.org/62987/1272_D11_2_red_green.jpg)
![](https://images.proteinatlas.org/62987/1272_D11_3_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-P18848-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt | P18848 |
| SMART | SM00338; |
| UniProt Domain [FT] | DOMAIN 278..341; /note="bZIP"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00978" |
| InterPro | IPR004827;IPR046347; |
| Pfam | PF00170; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000128272-ATF4/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| ATF3 | Intact, Biogrid | true |
| BFSP2 | Intact, Biogrid | true |
| BTRC | Intact, Biogrid | true |
| CCDC106 | Intact, Biogrid | true |
| CEBPG | Intact, Biogrid | true |
| DDIT3 | Intact, Biogrid | true |
| FOS | Intact, Biogrid | true |
| GOLGA8F | Intact, Biogrid | true |
