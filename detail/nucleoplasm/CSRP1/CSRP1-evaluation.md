...
## CSRP1 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | CSRP1 / CSRP, CYRP |
| 蛋白名称 | Cysteine and glycine-rich protein 1 |
| 蛋白大小 | 193 aa / 20.6 kDa |
| UniProt ID | P21291 |
| 评估日期 | 2026-06-03 |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: CSRP, CYRP |
...
2. SNV and haplotype analysis reveals new CSRP1 variants associated with growth and carcass traits.. *Gene*. PMID: 23537997
3. Cysteine- and glycine-rich protein 1 predicts prognosis and therapy response in patients with acute myeloid leukemia.. *Clinical and experimental medicine*. PMID: 38546813
4. CSRP1 Promotes Colon Adenocarcinoma Growth and Serves as an Independent Risk Biomarker for Worse Prognosis.. *Genetics research*. PMID: 37113556
5. PD-L1/PD-1 checkpoint pathway regulates astrocyte morphogenesis and myelination during brain development.. *Molecular psychiatry*. PMID: 40164696
...
**评价**: AlphaFold 中等质量（pLDDT=71.9，有序区 63.3%），结构基本可用。
...
**核心优势**:
1. CSRP1 — Cysteine and glycine-rich protein 1，较新颖，有一定研究但存在未探索领域。
...
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=CSRP1
- AlphaFold: https://alphafold.ebi.ac.uk/entry/P21291
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03


![[/Users/quii/Documents/Obsidian Vault/Projects/TEreg-finding/protein-interested/detail/nucleoplasm/CSRP1/CSRP1-PAE.png]]
