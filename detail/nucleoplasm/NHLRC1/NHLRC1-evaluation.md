...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | x4 | 28 | HPA: Nucleoplasm; 额外: Cytosol; UniProt: Endoplasmic reticulum; Nucleus |
| 蛋白大小 | 10/10 | x1 | 10 | 395 aa / 42.3 kDa |
| 研究新颖性 | 4/10 | x5 | 20 | PubMed strict=80 篇 (61-80 -> 4) |
| 三维结构 | 8/10 | x3 | 24 | AlphaFold v6 pLDDT=85.4; PDB: 无 |
| 调控结构域 | 8/10 | x2 | 16 | InterPro: IPR011042, IPR001258, IPR050952, IPR001841, I |
| PPI 网络 | 3/10 | x3 | 9 | STRING 15 partners; IntAct 9 interactions |
...
**核心优势**:
1. NHLRC1 -- E3 ubiquitin-protein ligase NHLRC1，有一定研究基础，但仍存在niche空间。
...
- STRING: https://string-db.org/network/9606.NHLRC1
- Packet data timestamp: 2026-06-03 23:43:24

---
*本报告为全量重评估 (Full Re-evaluation) -- Recovery from false-rejection。所有评分基于最新harvest packet数据，使用标准/180评分体系计算。*

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (supported)。来源: https://www.proteinatlas.org/ENSG00000187566-NHLRC1/subcellular

![](https://images.proteinatlas.org/78292/1922_C6_31_red_green.jpg)
![](https://images.proteinatlas.org/78292/1922_C6_32_red_green.jpg)
![](https://images.proteinatlas.org/78292/1980_C5_1_red_green.jpg)
![](https://images.proteinatlas.org/78292/1980_C5_3_red_green.jpg)
![](https://images.proteinatlas.org/78292/2163_C7_1_red_green.jpg)
![](https://images.proteinatlas.org/78292/2163_C7_3_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q6VVB1-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| InterPro | IPR011042;IPR001258;IPR050952;IPR001841;IPR013083;IPR017907; |
| Pfam | PF14634; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000187566-NHLRC1/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| EPM2A | Intact, Biogrid, Bioplex | true |
| BECN1 | Biogrid | false |
| DVL2 | Biogrid | false |
| GYS1 | Biogrid | false |
| HNRNPCL1 | Bioplex | false |
| NNAT | Biogrid | false |
| PCK1 | Bioplex | false |
| PPP1R3C | Biogrid | false |
