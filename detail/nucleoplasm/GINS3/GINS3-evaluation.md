...
## GINS3 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | GINS3 / PSF3 |
| 蛋白名称 | DNA replication complex GINS protein PSF3 |
| 蛋白大小 | 216 aa / 24.5 kDa |
| UniProt ID | Q9BRX5 |
| 评估日期 | 2026-06-03 |
...
| 蛋白大小 | 10/10 | ×1 | 10 | 216 aa / 24.5 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 10/10 | ×3 | 30 | AlphaFold v6 pLDDT=87.4; PDB: 2E9X, 2EHO, 2Q9Q, 6XTX, 6XTY, 7PFO, 7PLO |
| 调控结构域 | 8/10 | ×2 | 16 | InterPro: IPR021151, IPR036224, IPR010492, IPR038437, IPR055 |
...
**评价**: PDB实验结构（2E9X, 2EHO, 2Q9Q, 6XTX, 6XTY, 7PFO, 7PLO, 8B9D, 8OK2, 9E2Z）+ AlphaFold极高置信度预测（pLDDT=87.4），结构可信度极高。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR021151, IPR036224, IPR010492, IPR038437, IPR055221; Pfam: PF22466, PF05916 |
...
| Partner | 方法 | PMID |
|---------|------|------|
| b4388 | psi-mi:"MI:0398"(two hybrid pooling approach) | imex:IM-13779|pubmed:20711500 |
...
| KRT80 | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
| 维度 | 来源 | 结果 | 是否一致 |
|------|------|------|----------|
| 三维结构 | AlphaFold pLDDT=87.4 + PDB: 2E9X, 2EHO, 2Q9Q, 6XTX, 6XTY,  | pLDDT=87.4, v6 | 预测+实验 |
...
**核心优势**:
1. GINS3 — DNA replication complex GINS protein PSF3，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
