...
HPA 检索: https://www.proteinatlas.org/search/CENPO
...
| PMID | Title |
|---|---|
| 41751958 | FOXM1 Signaling Network Transcriptionally Upregulates Expression of Proteins Involved in Mitotic Progression to Induce High Proliferation and Chromoso |
| 41272700 | Bridging pharmacovigilance and genetic insight: investigating drugs and indications for breast cancer risk in women with autoimmune diseases. |
| 39684488 | Identification of Diagnostic and Prognostic Subnetwork Biomarkers for Women with Breast Cancer Using Integrative Genomic and Network-Based Analysis. |
| 39543244 | Enhancing risk stratification models in localized prostate cancer by novel validated tissue biomarkers. |
| 38890751 | High expression levels of centromere protein O participates in cell proliferation of human ovarian cancer. |
