...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Vesicles (supported)。来源: https://www.proteinatlas.org/ENSG00000141971-MVB12A/subcellular

![](https://images.proteinatlas.org/42231/719_B4_3_blue_red_green.jpg)
![](https://images.proteinatlas.org/42231/719_B4_4_blue_red_green.jpg)
![](https://images.proteinatlas.org/42231/764_B4_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/42231/764_B4_2_blue_red_green.jpg)
<!-- HPA_IF_REPAIR_END -->

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q96EY5-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt Domain [FT] | DOMAIN 9..151; /note="MABP"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00831"; DOMAIN 215..265; /note="UMA"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00830" |
| InterPro | IPR023341;IPR040335;IPR018798;IPR023340; |
| Pfam | PF10240; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000141971-MVB12A/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| CEP55 | Biogrid, Opencell | true |
| TSG101 | Biogrid, Opencell | true |
| VPS28 | Biogrid, Opencell, Bioplex | true |
| VPS37B | Biogrid, Opencell | true |
| AKR7A2 | Bioplex | false |
