...
## B3KY92 (cDNA FLJ16115 fis, clone ADRGL2000042, highly similar to Homo sapiens TSPY-like 2 (TSPYL2), mRNA) 核蛋白评估报告
...
|---|---|
| 基因名 | B3KY92 |
| 蛋白名称 | cDNA FLJ16115 fis, clone ADRGL2000042, highly similar to Homo sapiens TSPY-like 2 (TSPYL2), mRNA |
| UniProt ID | B3KY92 |
| 蛋白大小 | 287 aa |
| 评估日期 | 2026-06-29 |
...
**蛋白全称**: cDNA FLJ16115 fis, clone ADRGL2000042, highly similar to Homo sapiens TSPY-like 2 (TSPYL2), mRNA
...
HPA 检索: https://www.proteinatlas.org/search/B3KY92

### ESM 结构预测补充 (ESMFold Analysis)

**方法**: 使用 Meta ESM Metagenomic Atlas API 对全长蛋白序列进行 ab initio 折叠预测。
**PDB 文件**: `detail/_esm_structures/B3KY92_esmfold.pdb`
...
- UniProt: https://www.uniprot.org/uniprotkb/B3KY92
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B3KY92
