...
## FOXD4L3 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | FOXD4L3 |
| 蛋白名称 | Forkhead box protein D4-like 3 |
...
2. The molecular landscape of well differentiated retroperitoneal liposarcoma.. *The Journal of pathology*. PMID: 34156092
...
**评价**: AlphaFold 预测质量有限（pLDDT=56.2），有序残基占 23.5%。
...
|---------|---------------|--------------|---------|
| ANKRD20A2 | 0.615 | 0.059 | — |
| ZNF595 | 0.481 | 0.096 | — |
| OR13C3 | 0.480 | 0.000 | — |
| OR13C4 | 0.478 | 0.000 | — |
| GOLGA6L10 | 0.427 | 0.059 | — |
| MAP10 | 0.418 | 0.000 | — |
...
| KHDRBS2 | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
**核心优势**:
1. FOXD4L3 — Forkhead box protein D4-like 3，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/Q6VB84
- Protein Atlas: https://www.proteinatlas.org/ENSG00000187559-FOXD4L3/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FOXD4L3
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q6VB84
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000187559-FOXD4L3/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-Q6VB84-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000187559-FOXD4L3/interaction
