...
## B3KUP7 (cDNA FLJ40352 fis, clone TESTI2033505, highly similar to Ubiquitin-protein ligase CHFR) 核蛋白评估报告
...
|---|---|
| 基因名 | B3KUP7 |
| 蛋白名称 | cDNA FLJ40352 fis, clone TESTI2033505, highly similar to Ubiquitin-protein ligase CHFR |
| UniProt ID | B3KUP7 |
| 蛋白大小 | 349 aa |
| 评估日期 | 2026-06-29 |
...
**蛋白全称**: cDNA FLJ40352 fis, clone TESTI2033505, highly similar to Ubiquitin-protein ligase CHFR
...
HPA 检索: https://www.proteinatlas.org/search/B3KUP7

### ESM 结构预测补充 (ESMFold Analysis)

**方法**: 使用 Meta ESM Metagenomic Atlas API 对全长蛋白序列进行 ab initio 折叠预测。
**PDB 文件**: `detail/_esm_structures/B3KUP7_esmfold.pdb`
...
- UniProt: https://www.uniprot.org/uniprotkb/B3KUP7
- AlphaFold: https://alphafold.ebi.ac.uk/entry/B3KUP7
