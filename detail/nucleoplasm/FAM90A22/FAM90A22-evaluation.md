...
## FAM90A22 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | FAM90A22 / FAM90A22P |
| 蛋白名称 | Protein FAM90A22 |
...
| 别名(未计入scoring) | Aliases observed but not used for scoring: FAM90A22P |
...
**评价**: AlphaFold 预测质量有限（pLDDT=50.7），有序残基占 10.4%。
...
**核心优势**:
1. FAM90A22 — Protein FAM90A22，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
### 5. 数据来源
- UniProt: https://www.uniprot.org/uniprotkb/A8MWA6
- Protein Atlas: https://www.proteinatlas.org/ENSG00000285687-FAM90A22/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FAM90A22
- AlphaFold: https://alphafold.ebi.ac.uk/entry/A8MWA6
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03

<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (approved)。来源: https://www.proteinatlas.org/ENSG00000285687-FAM90A22/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-A8MWA6-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000285687-FAM90A22/interaction
