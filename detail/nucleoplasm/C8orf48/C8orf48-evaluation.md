...
## C8orf48 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | C8orf48 |
| 蛋白名称 | Uncharacterized protein C8orf48 |
| 蛋白大小 | 319 aa / 36.8 kDa |
| UniProt ID | Q96LL4 |
| 评估日期 | 2026-06-03 |

**IF 图像**:
![[Projects/TEreg-finding/protein-interested/detail/rejected/C8orf48/IF_images/A-431_1.jpg|A-431]]
![[Projects/TEreg-finding/protein-interested/detail/rejected/C8orf48/IF_images/U-251MG_1.jpg|U-251MG]]
...
| 🏗️ 三维结构 | 6/10 | ×3 | 18 | AlphaFold v6 pLDDT=65.0; PDB: 无 |
| 🧬 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR027932; Pfam: PF15379 |
...
**关键文献**:
1. C8orf48 inhibits the tumorigenesis of colorectal cancer by regulating the MAPK signaling pathway.. *Life sciences*. PMID: 33309715
2. Cell senescence abrogates the therapeutic potential of human mesenchymal stem cells in the lethal endotoxemia model.. *Stem cells (Dayton, Ohio)*. PMID: 24496748
...
**评价**: AlphaFold 预测质量有限（pLDDT=65.0），有序残基占 45.4%。

#### 3.5 结构域分析

| 来源 | 结构域 |
|------|--------|
| InterPro/Pfam | InterPro: IPR027932; Pfam: PF15379 |
...
| CARD10 | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
| GTF3C3 | psi-mi:"MI:0397"(two hybrid array) | pubmed:32814053|imex:IM-28217| |
...
**核心优势**:
1. C8orf48 — Uncharacterized protein C8orf48，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=C8orf48
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q96LL4
- STRING: https://string-db.org/network/9606.ENSP00000
- Packet data timestamp: 2026-06-03 04:27:24

<!-- AF_PAE_REPAIR_START -->
**PAE 图像修正（2026-06-05）**: AlphaFold 提供 predicted aligned error 图像；此前“PAE 图像暂无数据”的表述为未获取/未嵌入导致。

![](https://alphafold.ebi.ac.uk/files/AF-Q96LL4-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
Source: https://www.proteinatlas.org/ENSG00000164743-C8orf48/interaction
