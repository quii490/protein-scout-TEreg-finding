...
## GPR27 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | GPR27 / SREB1 |
| 蛋白名称 | Probable G-protein coupled receptor 27 |
| 蛋白大小 | 375 aa / 39.8 kDa |
| UniProt ID | Q9NS67 |
| 评估日期 | 2026-06-03 |
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 4/10 | ×4 | 16 | HPA: Nucleoplasm; 额外: Plasma membrane, Actin filaments, Cytosol; UniProt: Cell membrane |
| 蛋白大小 | 10/10 | ×1 | 10 | 375 aa / 39.8 kDa |
| 研究新颖性 | 10/10 | ×5 | 50 | PubMed strict=0 篇 (≤20→10) |
| 三维结构 | 7/10 | ×3 | 21 | AlphaFold v6 pLDDT=78.7; PDB: 无 |
| 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR051509, IPR000276, IPR017452; Pfam: PF00001 |
...
| 来源 | 定位 | 可信度 |
|------|------|--------|
| Protein Atlas (IF) | Nucleoplasm; 额外: Plasma membrane, Actin filaments, Cytosol | Approved |
...
**评价**: AlphaFold 中等质量（pLDDT=78.7，有序区 69.1%），结构基本可用。
...
| ANKRD13C | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
| TTYH3 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
...
| 定位 | UniProt + HPA | Cell membrane / Nucleoplasm; 额外: Plasma membrane, Actin filaments, | 一致 |
...
**核心优势**:
1. GPR27 — Probable G-protein coupled receptor 27，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
