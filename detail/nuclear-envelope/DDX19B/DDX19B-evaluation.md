...
<!-- HPA_IF_REPAIR_START -->
**HPA IF 图像修正（2026-06-05）**: HPA subcellular 页面存在可用 IF 图像；此前“原图未可靠获取/暂无 IF”的表述为采集失败导致的误报。HPA 定位: Nucleoplasm (uncertain)。来源: https://www.proteinatlas.org/ENSG00000157349-DDX19B/subcellular
...
![](https://alphafold.ebi.ac.uk/files/AF-Q9UMR2-F1-predicted_aligned_error_v6.png)
<!-- AF_PAE_REPAIR_END -->
...
| UniProt Domain [FT] | DOMAIN 125..295; /note="Helicase ATP-binding"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00541"; DOMAIN 306..474; /note="Helicase C-terminal"; /evidence="ECO:0000255\|PROSITE-ProRule:PRU00542" |
| InterPro | IPR011545;IPR014001;IPR001650;IPR027417;IPR014014; |
| Pfam | PF00270;PF00271; |

### humanPPI / HPA Interaction
Source: https://www.proteinatlas.org/ENSG00000157349-DDX19B/interaction

| Partner | Datasets | AF3/HPA structure |
|---|---|:--:|
| MIF4GD | Intact, Biogrid, Bioplex | true |
| ACOT6 | Bioplex | false |
| ALPI | Bioplex | false |
| APBA3 | Bioplex | false |
| ARL11 | Bioplex | false |
