...
## FAM156B 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | FAM156B / TMEM29 |
...
| PPI 网络 | 3/10 | ×3 | 9 | STRING 2 partners; IntAct 8 interactions |
...
**关键文献**:
1. A computational approach to candidate gene prioritization for X-linked mental retardation using annotation-based binary filtering and motif-based linear discriminatory analysis.. *Biology direct*. PMID: 21668950
...
![[Projects/TEreg-finding/protein-interested/detail/nuclear-envelope/FAM156B/FAM156B-PAE.png]]
...
| FAM156A | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
...
**PPI 互证分析**:
- STRING + IntAct 均有数据
- STRING partners: 2，IntAct interactions: 8
- 调控相关比例: 0 / 2 = 0%

**评价**: STRING 2 个预测互作，IntAct 8 个实验互作。调控相关配体占比 0%。
...
| PPI | STRING + IntAct | 2 + 8 interactions | 数据充分 |
...
**核心优势**:
1. FAM156B — Protein FAM156A/FAM156B，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
...
- Protein Atlas: https://www.proteinatlas.org/ENSG00000179304-FAM156B/subcellular
- PubMed: https://pubmed.ncbi.nlm.nih.gov/?term=FAM156B
- AlphaFold: https://alphafold.ebi.ac.uk/entry/Q8NDB6
- STRING: https://string-db.org/network/9606.ENSP00000
- Data fetched live: 2026-06-03


![[/Users/quii/Documents/Obsidian Vault/Projects/TEreg-finding/protein-interested/detail/nuclear-envelope/FAM156B/FAM156B-PAE.png]]
...
Source: https://www.proteinatlas.org/ENSG00000179304-FAM156B/interaction
