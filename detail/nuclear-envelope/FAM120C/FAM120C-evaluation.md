...
FAM120C（Constitutive coactivator of PPAR-gamma-like protein 2, 1096 aa, UniProt Q9NX05）。定位于Nuclear membrane（HPA Approved），额外Endoplasmic reticulum信号。InterPro注释IPR026784（FAM120 family）和IPR029060（FAM120C superfamily），Pfam未检出。AlphaFold pLDDT=68.2（有序区56.0%），无PDB实验结构。

从蛋白名称和功能注释角度，"PPAR-gamma辅助激活因子样蛋白"的命名提示FAM120C可能作为转录共激活因子发挥功能——PPAR-gamma是核受体超家族成员，调控脂质代谢和炎症基因的转录程序，其共激活因子（如MED1、PGC-1alpha）通过桥接核受体与染色质重塑机器和基础转录机器来激活靶基因转录。然而，没有文献直接证明FAM120C确实在PPAR-gamma转录调控中发挥作用——该注释基于序列同源性。

从PPI网络角度，STRING鉴定的最强预测伙伴是PHF8（0.877）和WNK3（0.872）。PHF8是H3K9me2/me1和H4K20me1去甲基酶——通过去除抑制性组蛋白修饰激活转录。若FAM120C与PHF8形成功能复合体，可能在染色质上去除抑制性修饰促进转录激活，这与共激活因子功能吻合。WNK3是调控离子转运的丝氨酸/苏氨酸激酶——其关联较难解释，但FAM120C与CTTNBP2（0.593，cortactin结合蛋白/肌动蛋白调控）和TAX1BP1（0.587，NF-κB信号调控因子）的关联暗示其可能跨多个信号通路。

从TE调控角度，PHF8的H3K9me2去甲基酶活性与TE沉默直接相关——H3K9me2是ERV和LINE-1转座子沉默的经典修饰标志。PHF8通过去除H3K9me2激活靶基因，在ERV LTR区域可能拮抗SETDB1/G9a的沉默功能。若FAM120C作为PHF8的支架/招募因子，可促进特定TE位点的H3K9me2去甲基化——这是一种"TE去沉默"机制而非抑制。综合评分71.1/100。建议：FAM120C-IP-MS确证PHF8互作；ChIP-seq鉴定FAM120C在TE区域的富集模式。

### HPA IF 图像

![](https://images.proteinatlas.org/54250/1472_H10_2_blue_red_green.jpg)
![](https://images.proteinatlas.org/54250/1472_H10_4_blue_red_green.jpg)
![](https://images.proteinatlas.org/54250/1021_F4_4_blue_red_green.jpg)
![](https://images.proteinatlas.org/54250/1021_F4_5_blue_red_green.jpg)
![](https://images.proteinatlas.org/54250/1019_F4_1_blue_red_green.jpg)
![](https://images.proteinatlas.org/54250/1019_F4_2_blue_red_green.jpg)
