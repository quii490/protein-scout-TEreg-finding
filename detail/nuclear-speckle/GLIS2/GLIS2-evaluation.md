...
## GLIS2 核蛋白评估报告 (Full Re-evaluation)
...
|------|------|
| 基因名 / 别名 | GLIS2 / NKL |
| 蛋白名称 | Zinc finger protein GLIS2 |
| 蛋白大小 | 524 aa / 55.7 kDa |
| UniProt ID | Q9BZE0 |
| 评估日期 | 2026-06-03 |
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | ×4 | 28 | HPA: Nucleoplasm; 额外: Basal body; UniProt: Nucleus speckle; Cytoplasm |
| 蛋白大小 | 10/10 | ×1 | 10 | 524 aa / 55.7 kDa |
...
| 来源 | 定位 | 可信度 |
|------|------|--------|
| Protein Atlas (IF) | Nucleoplasm; 额外: Basal body | Approved |
| UniProt | Nucleus speckle; Cytoplasm | Swiss-Prot/TrEMBL |
...
| 低置信 (pLDDT<50) 占比 | 60.5% |
| 有序区域 (pLDDT>70) 占比 | 30.2% |
| 可用 PDB 条目 | 无 |

**PAE 图像说明**: AlphaFold PAE 图像已重新获取并嵌入（见下方 PAE 图像修正块）；结构判断仍结合 pLDDT 与 PAE 综合判断。

**评价**: AlphaFold 预测质量有限（pLDDT=53.9），有序残基占 30.2%。
...
| 定位 | UniProt + HPA | Nucleus speckle; Cytoplasm / Nucleoplasm; 额外: Basal body | 一致 |
...
**核心优势**:
1. GLIS2 — Zinc finger protein GLIS2，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
