...
## GIPC3 核蛋白评估报告 (Full Re-evaluation)

### 1. 基本信息

| 项目 | 内容 |
|------|------|
| 基因名 / 别名 | GIPC3 / C19orf64 |
| 蛋白名称 | PDZ domain-containing protein GIPC3 |
| 蛋白大小 | 312 aa / 34.0 kDa |
| UniProt ID | Q8TF64 |
| 评估日期 | 2026-06-03 |
...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | ×4 | 28 | HPA: Nucleoplasm; 额外: Nuclear bodies, Golgi apparatus; UniProt: 无注释 |
| 蛋白大小 | 10/10 | ×1 | 10 | 312 aa / 34.0 kDa |
...
| 来源 | 定位 | 可信度 |
|------|------|--------|
| Protein Atlas (IF) | Nucleoplasm; 额外: Nuclear bodies, Golgi apparatus | Approved |
...
**评价**: AlphaFold 中等质量（pLDDT=84.9，有序区 81.4%），结构基本可用。
...
| ST6GAL2 | psi-mi:"MI:1356"(validated two hybrid) | pubmed:32296183|imex:IM-25472 |
| GIPC1 | psi-mi:"MI:0007"(anti tag coimmunoprecipitation) | pubmed:33961781|imex:IM-29278| |
...
**核心优势**:
1. GIPC3 — PDZ domain-containing protein GIPC3，极度新颖，几乎未被系统研究（PubMed ≤20篇）。
