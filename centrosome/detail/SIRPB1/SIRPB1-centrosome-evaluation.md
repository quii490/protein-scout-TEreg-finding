...
# SIRPB1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA047463
- **HPA IF reliability:** Uncertain
- **PubMed total:** 55 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000101307-SIRPB1
- **HPA location:** Vesicles, Centrosome
...
- HPA seed source: centrosome
- Antibody: HPA047463 (IF reliability: Uncertain)
