...
# CCDC65 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA038520, HPA057573
- **HPA IF reliability:** Approved
- **PubMed total:** 20 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000139537-CCDC65
- **HPA location:** Vesicles, Primary cilium transition zone, Centriolar satellite, Mid piece, Principal piece, Annulus
- **HPA main location:** Vesicles, Primary cilium transition zone, Centriolar satellite
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA038520, HPA057573 (IF reliability: Approved)
