...
# CBY1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA020360
- **HPA IF reliability:** Supported
- **PubMed total:** 63 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000100211-CBY1
...
- HPA seed source: centrosome
- Antibody: HPA020360 (IF reliability: Supported)
