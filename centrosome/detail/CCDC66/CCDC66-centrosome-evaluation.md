...
# CCDC66 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA044185, HPA051937
- **HPA IF reliability:** Supported
- **PubMed total:** 42 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000180376-CCDC66
- **HPA location:** Vesicles, Plasma membrane, Cell Junctions, Midbody ring, Primary cilium, Centriolar satellite, Cytosol, Perinuclear theca, End piece
- **HPA main location:** Primary cilium, Centriolar satellite, Perinuclear theca
- **IF image:** Available
...
- **Total PubMed:** 42 papers
- **Centrosome-specific:** 8
...
| PubMed/literature | 8/20 | 42 papers total.  |
| PPI/network | 10/20 | Pending PPI assessment. |
| Structure/domain | 5/10 | Pending structural assessment. |
| Novelty/specificity | 6/10 | 42 papers.  |

- **Preliminary final score:** **46/100**
...
- HPA seed source: satellite
- Antibody: HPA044185, HPA051937 (IF reliability: Supported)
