...
# PAOX — Centrosome Module Evaluation
...
- **HPA antibody:** HPA047782
- **HPA IF reliability:** Uncertain
- **PubMed total:** 81 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000148832-PAOX
...
- HPA seed source: centrosome
- Antibody: HPA047782 (IF reliability: Uncertain)
