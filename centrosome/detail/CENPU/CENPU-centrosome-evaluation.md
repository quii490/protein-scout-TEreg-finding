...
# CENPU — Centrosome Module Evaluation
...
- **HPA antibody:** HPA022048
- **HPA IF reliability:** Supported
- **PubMed total:** 76 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000151725-CENPU
...
- HPA seed source: satellite
- Antibody: HPA022048 (IF reliability: Supported)
