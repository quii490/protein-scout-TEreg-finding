...
# CNTROB — Centrosome Module Evaluation
...
- **HPA antibody:** HPA023319, HPA023320, HPA023321, HPA023325
- **HPA IF reliability:** Supported
- **PubMed total:** 31 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000170037-CNTROB
- **HPA location:** Centrosome, Basal body, Cytosol, Flagellar centriole
- **HPA main location:** Centrosome, Basal body, Flagellar centriole
- **IF image:** Available
...
- **Total PubMed:** 31 papers
- **Centrosome-specific:** 22
...
| PubMed/literature | 8/20 | 31 papers total.  |
| PPI/network | 10/20 | Pending PPI assessment. |
| Structure/domain | 5/10 | Pending structural assessment. |
| Novelty/specificity | 6/10 | 31 papers.  |

- **Preliminary final score:** **48/100**
...
- HPA seed source: centrosome
- Antibody: HPA023319, HPA023320, HPA023321, HPA023325 (IF reliability: Supported)
