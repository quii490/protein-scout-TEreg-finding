...
# TUBGCP5 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA039366, HPA040366
- **HPA IF reliability:** Supported
- **PubMed total:** 53 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000275835-TUBGCP5
- **HPA location:** Primary cilium, Primary cilium transition zone, Centrosome, Basal body, Cytosol
...
- **Total PubMed:** 53 papers
- **Centrosome-specific:** 5
...
- HPA seed source: centrosome
- Antibody: HPA039366, HPA040366 (IF reliability: Supported)
