...
# TSSK1B — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000212122-TSSK1B
- **HPA location:** Nuclear bodies, Centrosome, Basal body, Perinuclear theca, Principal piece, End piece, Annulus
- **HPA main location:** Nuclear bodies, Principal piece
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA027827 (IF reliability: Approved)
