...
# ARL2BP — Centrosome Module Evaluation
...
- **HPA antibody:** HPA043066, HPA048440
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000102931-ARL2BP
- **HPA location:** Nucleoplasm, Centrosome, Basal body, Cytosol
- **HPA main location:** Nucleoplasm, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA043066, HPA048440 (IF reliability: Supported)
