...
# ENSG00000268870 — Centrosome Module Evaluation

## 1. 基本信息

- **Gene:** ENSG00000268870
- **Ensembl:** ENSG00000268870
...
- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000268870-ENSG00000268870
- **HPA location:** Nucleoplasm, Centriolar satellite
- **HPA main location:** Nucleoplasm
- **IF image:** Available


![[ENSG00000268870_IF_1.jpg]]
...
- HPA seed source: satellite
- Antibody: HPA003150, HPA018683 (IF reliability: Uncertain)
