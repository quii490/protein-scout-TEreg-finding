...
# ENSG00000285188 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA048975, HPA054218
- **HPA IF reliability:** Approved
- **PubMed total:** 0 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000285188-ENSG00000285188
- **HPA location:** Midbody ring, Centrosome, Basal body, Cytosol
- **HPA main location:** Centrosome, Basal body, Cytosol
- **IF image:** Available


![[ENSG00000285188_IF_1.jpg]]
...
- HPA seed source: centrosome
- Antibody: HPA048975, HPA054218 (IF reliability: Approved)
