...
# DCAF13 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA044504
- **HPA IF reliability:** Supported
- **PubMed total:** 51 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000164934-DCAF13
- **HPA location:** Nucleoplasm, Nucleoli, Cell Junctions, Centrosome, Cytosol
- **HPA main location:** Nucleoplasm, Nucleoli
...
- HPA seed source: centrosome
- Antibody: HPA044504 (IF reliability: Supported)
