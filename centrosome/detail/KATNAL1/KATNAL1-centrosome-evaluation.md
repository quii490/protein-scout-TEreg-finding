...
# KATNAL1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA039759
- **HPA IF reliability:** Supported
- **PubMed total:** 40 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000102781-KATNAL1
- **HPA location:** Mitotic spindle, Centrosome, Mitochondria, Cytosol
...
- HPA seed source: centrosome
- Antibody: HPA039759 (IF reliability: Supported)
