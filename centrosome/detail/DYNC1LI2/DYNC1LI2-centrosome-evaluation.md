...
# DYNC1LI2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA049538, HPA057201
- **HPA IF reliability:** Approved
- **PubMed total:** 22 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000135720-DYNC1LI2
- **HPA location:** Centrosome, Cytosol, End piece
- **HPA main location:** Centrosome, End piece
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA049538, HPA057201 (IF reliability: Approved)
