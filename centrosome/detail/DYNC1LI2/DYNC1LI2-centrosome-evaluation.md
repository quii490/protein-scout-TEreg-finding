...
- **HPA 来源:** 中心体 ✓
- **HPA 链接:** https://www.proteinatlas.org/ENSG00000135720-DYNC1LI2
- **HPA 定位:** Centrosome, Cytosol, End piece
- **IF 图像状态:** 已获取 (1 张, selected)


<!-- CENTROSOME_HPA_IF_START -->
**HPA IF 图像（2026-06-08）**: HPA subcellular 页面存在可用 IF 图像。
HPA 定位: Centrosome, Cytosol, End piece。HPA IF 可靠性: approved。
来源: https://www.proteinatlas.org/ENSG00000135720-DYNC1LI2/subcellular

![](https://images.proteinatlas.org/49538/2199_F10_14_selected.jpg)
...
pLDDT 数据可用 (UniProt: O43237)。PDB 模型: https://alphafold.ebi.ac.uk/files/AF-O43237-F1-model_v6.pdb
...
| 维度 | 评分 | 依据 |
|---|---:|---|
| 中心体证据 | 16/20 | HPA 中心体标注。定位: Centrosome, Cytosol, End piece |
...
- HPA 来源: 中心体
- 抗体: HPA049538, HPA057201（IF 可靠性: Approved）
- 建议: 核实中心体 IF 文献定位
