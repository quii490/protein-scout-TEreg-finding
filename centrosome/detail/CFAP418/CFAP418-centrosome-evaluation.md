...
# CFAP418 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA024198
- **HPA IF reliability:** Approved
- **PubMed total:** 16 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000156172-CFAP418
- **HPA location:** Vesicles, Plasma membrane, Cell Junctions, Primary cilium, Centrosome
- **HPA main location:** Plasma membrane, Primary cilium
...
- HPA seed source: centrosome
- Antibody: HPA024198 (IF reliability: Approved)
