...
- **HPA 来源:** 中心体 ✓
- **HPA 链接:** https://www.proteinatlas.org/ENSG00000008323-PLEKHG6
- **HPA 定位:** Cell Junctions, Centrosome
- **IF 图像状态:** 已获取 (1 张, selected)


<!-- CENTROSOME_HPA_IF_START -->
**HPA IF 图像（2026-06-08）**: HPA subcellular 页面存在可用 IF 图像。
HPA 定位: Cell Junctions, Centrosome。HPA IF 可靠性: supported。
来源: https://www.proteinatlas.org/ENSG00000008323-PLEKHG6/subcellular

![](https://images.proteinatlas.org/58230/1251_H6_2_selected.jpg)
...
| 维度 | 评分 | 依据 |
|---|---:|---|
| 中心体证据 | 16/20 | HPA 中心体标注。定位: Cell Junctions, Centrosome |
...
- HPA 来源: 中心体
- 抗体: HPA041459, HPA058230（IF 可靠性: Supported）
- 建议: 核实中心体 IF 文献定位
