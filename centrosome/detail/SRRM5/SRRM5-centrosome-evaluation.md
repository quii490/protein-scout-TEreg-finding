...
# SRRM5 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA047399, HPA052924
- **HPA IF reliability:** Approved
- **PubMed total:** 1 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000226763-SRRM5
...
- HPA seed source: centrosome
- Antibody: HPA047399, HPA052924 (IF reliability: Approved)
