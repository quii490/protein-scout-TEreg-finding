...
# LRRN1 — Centrosome Module Evaluation
...
- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000175928-LRRN1
- **HPA location:** Endoplasmic reticulum, Golgi apparatus, Vesicles, Centriolar satellite, Basal body
- **HPA main location:** Endoplasmic reticulum
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA011071 (IF reliability: Approved)
