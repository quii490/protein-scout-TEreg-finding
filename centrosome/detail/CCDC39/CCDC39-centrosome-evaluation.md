...
# CCDC39 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA035363, HPA035364
- **HPA IF reliability:** Uncertain
- **PubMed total:** 93 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000284862-CCDC39
- **HPA location:** Nucleoplasm, Centrosome, Basal body, Acrosome
- **HPA main location:** Nucleoplasm, Centrosome, Basal body, Acrosome
- **IF image:** Available
...
- **Total PubMed:** 93 papers
- **Centrosome-specific:** 53
...
- HPA seed source: centrosome
- Antibody: HPA035363, HPA035364 (IF reliability: Uncertain)
