...
# C1QTNF2 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000145861-C1QTNF2
- **HPA location:** Golgi apparatus, Centrosome
- **HPA main location:** Golgi apparatus, Centrosome
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA061290 (IF reliability: Approved)
