...
# ENSG00000280571 — Centrosome Module Evaluation
...
- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000280571-ENSG00000280571
- **HPA location:** Nucleoplasm, Centriolar satellite, Basal body, Cytosol
- **HPA main location:** Centriolar satellite
- **IF image:** Available


![[ENSG00000280571_IF_1.jpg]]
...
- HPA seed source: satellite
- Antibody: HPA047429 (IF reliability: Approved)
