...
# MAP9 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000164114-MAP9
- **HPA location:** Nuclear speckles, Primary cilium, Primary cilium transition zone, Centrosome
- **HPA main location:** Primary cilium, Primary cilium transition zone
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA037864 (IF reliability: Approved)
