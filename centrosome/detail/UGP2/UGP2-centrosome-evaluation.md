...
# UGP2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA034696, HPA034697, HPA064836
- **HPA IF reliability:** Approved
- **PubMed total:** 97 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000169764-UGP2
- **HPA location:** Nucleoplasm, Centrosome, Mitochondria
- **HPA main location:** Centrosome, Mitochondria
...
- HPA seed source: centrosome
- Antibody: HPA034696, HPA034697, HPA064836 (IF reliability: Approved)
