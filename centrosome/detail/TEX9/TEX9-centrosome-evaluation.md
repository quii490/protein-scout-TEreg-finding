...
# TEX9 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA039415, HPA042036
- **HPA IF reliability:** Approved
- **PubMed total:** 7 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000151575-TEX9
- **HPA location:** Nucleoplasm, Nucleoli fibrillar center, Vesicles, Primary cilium, Centrosome, Basal body, Cytosol
- **HPA main location:** Primary cilium, Centrosome, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA039415, HPA042036 (IF reliability: Approved)
