...
# B9D2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA042229, HPA042618
- **HPA IF reliability:** Uncertain
- **PubMed total:** 24 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000123810-B9D2
- **HPA location:** Nucleoli, Golgi apparatus, Vesicles, Centrosome, Basal body
- **HPA main location:** Nucleoli, Golgi apparatus
- **IF image:** Available
...
- **Total PubMed:** 24 papers
- **Centrosome-specific:** 15
...
- HPA seed source: centrosome
- Antibody: HPA042229, HPA042618 (IF reliability: Uncertain)
