...
# ATAD5 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA066823
- **HPA IF reliability:** Approved
- **PubMed total:** 68 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000176208-ATAD5
- **HPA location:** Nucleoplasm, Cytokinetic bridge, Centriolar satellite, Cytosol
...
- HPA seed source: satellite
- Antibody: HPA066823 (IF reliability: Approved)
