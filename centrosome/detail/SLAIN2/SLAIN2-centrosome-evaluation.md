...
# SLAIN2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA035824, HPA063599
- **HPA IF reliability:** Supported
- **PubMed total:** 18 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000109171-SLAIN2
- **HPA location:** Primary cilium tip, Centrosome, Basal body, Cytosol
- **HPA main location:** Centrosome, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA035824, HPA063599 (IF reliability: Supported)
