...
- **HPA 来源:** 中心粒卫星 ✓
- **HPA 链接:** https://www.proteinatlas.org/ENSG00000168172-HOOK3
- **HPA 定位:** Golgi apparatus, Centriolar satellite, Cytosol
- **IF 图像状态:** 已获取 (1 张, selected)


<!-- CENTROSOME_HPA_IF_START -->
**HPA IF 图像（2026-06-08）**: HPA subcellular 页面存在可用 IF 图像。
HPA 定位: Golgi apparatus, Centriolar satellite, Cytosol。HPA IF 可靠性: supported。
来源: https://www.proteinatlas.org/ENSG00000168172-HOOK3/subcellular

![](https://images.proteinatlas.org/24756/230_A8_1_selected.jpg)
...
|---|---|---|---|
| BICD2 | 0.999 | 0.000 | 0.000 | 0.000 |
| AKTIP | 0.998 | 0.000 | 0.000 | 0.000 |
| HOOK3 | 0.996 | 0.000 | 0.000 | 0.000 |
| HOOK2 | 0.995 | 0.000 | 0.000 | 0.000 |
| HOOK1 | 0.994 | 0.000 | 0.000 | 0.000 |
| HOOK3 | 0.992 | 0.000 | 0.000 | 0.000 |
| HOOK1 | 0.990 | 0.000 | 0.000 | 0.000 |
| HOOK1 | 0.987 | 0.000 | 0.000 | 0.000 |
| HOOK3 | 0.986 | 0.000 | 0.000 | 0.000 |
| HOOK2 | 0.981 | 0.000 | 0.000 | 0.000 |
...
| 维度 | 评分 | 依据 |
|---|---:|---|
| 中心体证据 | 14/20 | HPA 中心粒卫星标注。定位: Golgi apparatus, Centriolar satellite, Cytosol |
