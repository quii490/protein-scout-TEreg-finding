...
# CTNNBL1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA004742, HPA027906, HPA027907
- **HPA IF reliability:** Supported
- **PubMed total:** 48 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000132792-CTNNBL1
...
- HPA seed source: centrosome
- Antibody: HPA004742, HPA027906, HPA027907 (IF reliability: Supported)
