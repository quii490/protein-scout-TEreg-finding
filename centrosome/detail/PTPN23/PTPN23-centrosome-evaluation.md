...
# PTPN23 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA016845
- **HPA IF reliability:** Supported
- **PubMed total:** 75 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000076201-PTPN23
- **HPA location:** Nucleoplasm, Nuclear bodies, Vesicles, Centriolar satellite, Basal body, Cytosol, Calyx, Mid piece
- **HPA main location:** Nucleoplasm, Nuclear bodies, Basal body
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA016845 (IF reliability: Supported)
