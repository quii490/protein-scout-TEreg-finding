...
# KIF6 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA038811, HPA058624
- **HPA IF reliability:** Approved
- **PubMed total:** 92 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000164627-KIF6
- **HPA location:** Nucleoplasm, Centrosome, Basal body, Cytosol
...
- HPA seed source: centrosome
- Antibody: HPA038811, HPA058624 (IF reliability: Approved)
