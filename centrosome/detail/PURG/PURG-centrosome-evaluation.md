...
# PURG — Centrosome Module Evaluation
...
- **HPA antibody:** HPA047746
- **HPA IF reliability:** Approved
- **PubMed total:** 60 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000172733-PURG
- **HPA location:** Nucleoplasm, Nucleoli, Plasma membrane, Cytokinetic bridge, Centrosome, Basal body
...
- HPA seed source: centrosome
- Antibody: HPA047746 (IF reliability: Approved)
