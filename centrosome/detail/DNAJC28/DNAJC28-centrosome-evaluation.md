...
# DNAJC28 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA018003, HPA030076, HPA077153
- **HPA IF reliability:** Approved
- **PubMed total:** 9 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000177692-DNAJC28
- **HPA location:** Nucleoplasm, Nuclear bodies, Centrosome, Cytosol
- **HPA main location:** Nucleoplasm, Centrosome
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA018003, HPA030076, HPA077153 (IF reliability: Approved)
