...
# NEK6 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** NEK6
- **Ensembl:** ENSG00000119408
- **HPA seed source:** satellite
- **PubMed total:** 177 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 177 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000119408-NEK6
