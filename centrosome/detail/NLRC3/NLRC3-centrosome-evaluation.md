...
# NLRC3 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** NLRC3
- **Ensembl:** ENSG00000167984
- **HPA seed source:** satellite
- **PubMed total:** 184 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 184 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000167984-NLRC3
