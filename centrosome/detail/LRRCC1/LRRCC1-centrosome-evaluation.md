...
# LRRCC1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA012893, HPA075880
- **HPA IF reliability:** Supported
- **PubMed total:** 8 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000133739-LRRCC1
- **HPA location:** Vesicles, Primary cilium, Primary cilium tip, Centrosome, Basal body, Cytosol
...
- **Total PubMed:** 8 papers
- **Centrosome-specific:** 4
...
- HPA seed source: centrosome
- Antibody: HPA012893, HPA075880 (IF reliability: Supported)
