...
# DNAL4 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA003647
- **HPA IF reliability:** Approved
- **PubMed total:** 10 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000100246-DNAL4
- **HPA location:** Nucleoplasm, Nucleoli, Primary cilium transition zone, Centrosome, Basal body, Cytosol, Acrosome, Equatorial segment, Perinuclear theca, Calyx, Principal piece
- **HPA main location:** Centrosome, Basal body, Acrosome
...
- HPA seed source: centrosome
- Antibody: HPA003647 (IF reliability: Approved)
