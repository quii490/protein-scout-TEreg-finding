...
# AGBL5 — Centrosome Module Evaluation
...
- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000084693-AGBL5
- **HPA location:** Microtubules, Cytokinetic bridge, Primary cilium, Centriolar satellite, Basal body
- **HPA main location:** Cytokinetic bridge, Primary cilium
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA030981 (IF reliability: Approved)
