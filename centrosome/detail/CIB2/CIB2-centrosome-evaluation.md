...
# CIB2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA036697
- **HPA IF reliability:** Uncertain
- **PubMed total:** 100 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000136425-CIB2
- **HPA location:** Nucleoplasm, Primary cilium transition zone, Centrosome, Cytosol
...
- HPA seed source: centrosome
- Antibody: HPA036697 (IF reliability: Uncertain)
