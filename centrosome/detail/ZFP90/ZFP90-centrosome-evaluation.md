...
# ZFP90 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA029017
- **HPA IF reliability:** Supported
- **PubMed total:** 28 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000184939-ZFP90
...
- HPA seed source: centrosome
- Antibody: HPA029017 (IF reliability: Supported)
