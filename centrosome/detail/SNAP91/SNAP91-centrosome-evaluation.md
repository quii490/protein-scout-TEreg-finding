...
# SNAP91 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** SNAP91
- **Ensembl:** ENSG00000065609
- **HPA seed source:** satellite
- **PubMed total:** 223 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 223 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000065609-SNAP91
