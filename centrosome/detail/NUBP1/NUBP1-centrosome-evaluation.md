...
# NUBP1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA041656, HPA041799
- **HPA IF reliability:** Supported
- **PubMed total:** 41 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000103274-NUBP1
- **HPA location:** Golgi apparatus, Centrosome, Cytosol, Mid piece, Principal piece, End piece
- **HPA main location:** Cytosol, Mid piece, Principal piece, End piece
- **IF image:** Available
...
- **Total PubMed:** 41 papers
- **Centrosome-specific:** 6
...
- HPA seed source: centrosome
- Antibody: HPA041656, HPA041799 (IF reliability: Supported)
