...
# PINLYP — Centrosome Module Evaluation

## 1. 基本信息

- **Gene:** PINLYP
- **Ensembl:** ENSG00000234465
- **HPA seed source:** centrosome
- **HPA antibody:** HPA061218
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000234465-PINLYP
- **HPA location:** Vesicles, Microtubules, Cytokinetic bridge, Mitotic spindle, Primary cilium, Centrosome, Basal body
- **HPA main location:** Vesicles, Microtubules, Primary cilium
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA061218 (IF reliability: Approved)
