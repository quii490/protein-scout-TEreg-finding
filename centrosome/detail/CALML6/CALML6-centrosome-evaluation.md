...
# CALML6 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000169885-CALML6
- **HPA location:** Nucleoplasm, Nuclear speckles, Nuclear bodies, Vesicles, Centrosome, Cytosol
- **HPA main location:** Nuclear speckles
...
- HPA seed source: centrosome
- Antibody: HPA005912 (IF reliability: Supported)
