...
# FCMR — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000162894-FCMR
- **HPA location:** Nucleoplasm, Golgi apparatus, Plasma membrane, Centrosome
- **HPA main location:** Nucleoplasm, Plasma membrane
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA003910 (IF reliability: Approved)
