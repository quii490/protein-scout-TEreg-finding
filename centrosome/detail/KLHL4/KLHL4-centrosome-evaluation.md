...
*HPA IF 图像链接失效（404）。已查询 https://www.proteinatlas.org/ENSG00000102271-KLHL4/subcellular，无可用替代图像。*
...
pLDDT 数据可用 (UniProt: Q9C0H6)。PDB 模型: https://alphafold.ebi.ac.uk/files/AF-Q9C0H6-F1-model_v6.pdb

*InterPro: BACK, Beta-prop_ATRN-MKLN-like, BTB/POZ_dom, Kelch-typ_b-propeller, Kelch_1, SKP1/BTB/POZ_sf*
*Pfam: BACK, Beta-prop_ATRN-LZTR1, BTB*
