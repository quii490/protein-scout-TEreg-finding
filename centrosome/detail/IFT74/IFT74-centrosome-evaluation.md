...
# IFT74 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA020247, HPA026684
- **HPA IF reliability:** Supported
- **PubMed total:** 59 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000096872-IFT74
- **HPA location:** Golgi apparatus, Centriolar satellite, Basal body, Cytosol
- **HPA main location:** Golgi apparatus, Centriolar satellite, Basal body
- **IF image:** Available
...
- **Total PubMed:** 59 papers
- **Centrosome-specific:** 39
...
- HPA seed source: satellite
- Antibody: HPA020247, HPA026684 (IF reliability: Supported)
