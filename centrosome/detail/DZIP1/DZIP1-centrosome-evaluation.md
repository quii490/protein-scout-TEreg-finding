...
# DZIP1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA054891, HPA057272
- **HPA IF reliability:** Supported
- **PubMed total:** 66 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000134874-DZIP1
...
- HPA seed source: centrosome
- Antibody: HPA054891, HPA057272 (IF reliability: Supported)
