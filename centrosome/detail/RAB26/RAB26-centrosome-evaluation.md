...
# RAB26 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA075624
- **HPA IF reliability:** Uncertain
- **PubMed total:** 65 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000167964-RAB26
- **HPA location:** Vesicles, Plasma membrane, Cell Junctions, Centrosome, Cytosol
- **HPA main location:** Plasma membrane, Centrosome
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA075624 (IF reliability: Uncertain)
