...
# ISM2 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** ISM2
- **Ensembl:** ENSG00000100593
- **HPA seed source:** centrosome
- **PubMed total:** 795 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 795 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000100593-ISM2
