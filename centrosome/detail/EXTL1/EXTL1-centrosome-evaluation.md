...
# EXTL1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA010726, HPA037749
- **HPA IF reliability:** Approved
- **PubMed total:** 30 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000158008-EXTL1
...
- HPA seed source: centrosome
- Antibody: HPA010726, HPA037749 (IF reliability: Approved)
