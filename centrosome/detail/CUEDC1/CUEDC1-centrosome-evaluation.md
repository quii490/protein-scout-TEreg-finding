...
# CUEDC1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA023050, HPA024836
- **HPA IF reliability:** Approved
- **PubMed total:** 14 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000180891-CUEDC1
- **HPA location:** Plasma membrane, Microtubules, Cytokinetic bridge, Mitotic spindle, Primary cilium, Primary cilium tip, Centrosome, Basal body, Cytosol
- **HPA main location:** Plasma membrane, Primary cilium, Centrosome, Basal body
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA023050, HPA024836 (IF reliability: Approved)
