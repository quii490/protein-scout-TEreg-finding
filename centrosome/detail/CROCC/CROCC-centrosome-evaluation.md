...
# CROCC — Centrosome Module Evaluation
...
- **HPA antibody:** HPA021191, HPA021762
- **HPA IF reliability:** Supported
- **PubMed total:** 54 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000058453-CROCC
- **HPA location:** Plasma membrane, Primary cilium transition zone, Centrosome, Basal body, Mid piece
- **HPA main location:** Centrosome, Basal body
- **IF image:** Available
...
- **Total PubMed:** 54 papers
- **Centrosome-specific:** 38
...
- HPA seed source: centrosome
- Antibody: HPA021191, HPA021762 (IF reliability: Supported)
