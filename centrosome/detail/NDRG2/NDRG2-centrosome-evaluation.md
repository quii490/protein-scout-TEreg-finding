...
# NDRG2 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** NDRG2
- **Ensembl:** ENSG00000165795
- **HPA seed source:** satellite
- **PubMed total:** 452 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 452 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000165795-NDRG2
