...
# GPAA1 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000197858-GPAA1
- **HPA location:** Endoplasmic reticulum, Centrosome, Mitochondria, Cytosol
- **HPA main location:** Endoplasmic reticulum, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA077224 (IF reliability: Approved)
