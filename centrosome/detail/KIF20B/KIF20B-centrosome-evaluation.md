...
# KIF20B — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000138182-KIF20B
- **HPA location:** Nucleoplasm, Cytokinetic bridge, Midbody, Centrosome, Basal body, Cytosol, Perinuclear theca
- **HPA main location:** Nucleoplasm, Cytokinetic bridge, Basal body
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA050214 (IF reliability: Supported)
