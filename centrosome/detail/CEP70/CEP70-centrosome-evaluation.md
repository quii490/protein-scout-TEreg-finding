...
# CEP70 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA036941, HPA036942
- **HPA IF reliability:** Approved
- **PubMed total:** 26 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000114107-CEP70
- **HPA location:** Nucleoplasm, Primary cilium, Centrosome, Basal body, Cytosol
- **HPA main location:** Nucleoplasm, Primary cilium, Cytosol
- **IF image:** Available
...
- **Total PubMed:** 26 papers
- **Centrosome-specific:** 18
...
| PubMed/literature | 8/20 | 26 papers total.  |
| PPI/network | 10/20 | Pending PPI assessment. |
| Structure/domain | 5/10 | Pending structural assessment. |
| Novelty/specificity | 8/10 | 26 papers.  |

- **Preliminary final score:** **49/100**
...
- HPA seed source: centrosome
- Antibody: HPA036941, HPA036942 (IF reliability: Approved)
