...
# MAMLD1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA003923
- **HPA IF reliability:** Supported
- **PubMed total:** 98 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000013619-MAMLD1
- **HPA location:** Nucleoplasm, Nuclear bodies, Golgi apparatus, Centrosome
...
- HPA seed source: centrosome
- Antibody: HPA003923 (IF reliability: Supported)
