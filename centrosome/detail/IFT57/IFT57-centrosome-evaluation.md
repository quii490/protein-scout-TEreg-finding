...
# IFT57 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA035514, HPA035515
- **HPA IF reliability:** Approved
- **PubMed total:** 67 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000114446-IFT57
- **HPA location:** Golgi apparatus, Primary cilium, Primary cilium transition zone, Centriolar satellite, Basal body, Cytosol, Mid piece
- **HPA main location:** Golgi apparatus, Primary cilium, Basal body, Mid piece
- **IF image:** Available
...
- **Total PubMed:** 67 papers
- **Centrosome-specific:** 33
...
| PubMed/literature | 6/20 | 67 papers total.  |
| PPI/network | 10/20 | Pending PPI assessment. |
| Structure/domain | 5/10 | Pending structural assessment. |
| Novelty/specificity | 4/10 | 67 papers.  |

- **Preliminary final score:** **42/100**
...
- HPA seed source: satellite
- Antibody: HPA035514, HPA035515 (IF reliability: Approved)
