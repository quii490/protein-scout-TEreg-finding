...
# PELI2 — Centrosome Module Evaluation
...
- **HPA seed source:** both ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000139946-PELI2
- **HPA location:** Nucleoplasm, Nucleoli, Intermediate filaments, Centriolar satellite, Centrosome, Basal body, Cytosol
- **HPA main location:** Nucleoplasm, Nucleoli, Basal body
- **IF image:** Available
...
- HPA seed source: both
- Antibody: HPA053182 (IF reliability: Approved)
