...
# GATD3 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000160221-GATD3
- **HPA location:** Centrosome, Mitochondria
- **HPA main location:** Mitochondria
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA018517 (IF reliability: Approved)
