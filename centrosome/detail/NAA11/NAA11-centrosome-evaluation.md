...
# NAA11 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA035922
- **HPA IF reliability:** Supported
- **PubMed total:** 11 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000156269-NAA11
- **HPA location:** Nucleoplasm, Golgi apparatus, Primary cilium, Centrosome, Basal body, Cytosol
- **HPA main location:** Golgi apparatus, Centrosome, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA035922 (IF reliability: Supported)
