...
# SFR1 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000156384-SFR1
- **HPA location:** Nucleoplasm, Nucleoli rim, Centrosome
- **HPA main location:** Nucleoli rim
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA039617 (IF reliability: Supported)
