...
# CEP20 — Centrosome Module Evaluation

## 1. 基本信息

- **Gene:** CEP20
- **Ensembl:** ENSG00000133393
- **HPA seed source:** both
- **HPA antibody:** HPA040599
...
- **HPA seed source:** both ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000133393-CEP20
- **HPA location:** Nucleoplasm, Centriolar satellite, Centrosome, Basal body
- **HPA main location:** Centriolar satellite, Centrosome, Basal body
- **IF image:** Available
...
- HPA seed source: both
- Antibody: HPA040599 (IF reliability: Supported)
