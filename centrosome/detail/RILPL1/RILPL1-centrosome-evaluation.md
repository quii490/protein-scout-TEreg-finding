...
# RILPL1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA041314
- **HPA IF reliability:** Approved
- **PubMed total:** 44 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000188026-RILPL1
- **HPA location:** Nucleoplasm, Plasma membrane, Primary cilium, Centrosome, Basal body, Cytosol
- **HPA main location:** Plasma membrane, Primary cilium, Cytosol
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA041314 (IF reliability: Approved)
