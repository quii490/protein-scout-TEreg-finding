...
# TTC21B — Centrosome Module Evaluation
...
- **HPA antibody:** HPA073293
- **HPA IF reliability:** Approved
- **PubMed total:** 82 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000123607-TTC21B
- **HPA location:** Primary cilium, Centriolar satellite, Basal body, Cytosol, Connecting piece, Mid piece, Principal piece, End piece
- **HPA main location:** Primary cilium, Centriolar satellite, Basal body
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA073293 (IF reliability: Approved)
