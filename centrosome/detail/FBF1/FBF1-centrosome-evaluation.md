...
# FBF1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA023677
- **HPA IF reliability:** Supported
- **PubMed total:** 74 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000188878-FBF1
...
- HPA seed source: centrosome
- Antibody: HPA023677 (IF reliability: Supported)
