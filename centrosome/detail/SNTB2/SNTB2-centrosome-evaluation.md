...
# SNTB2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA001394
- **HPA IF reliability:** Approved
- **PubMed total:** 15 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000168807-SNTB2
- **HPA location:** Nucleoplasm, Golgi apparatus, Plasma membrane, Primary cilium transition zone, Centriolar satellite, Basal body
- **HPA main location:** Golgi apparatus, Plasma membrane, Centriolar satellite, Basal body
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA001394 (IF reliability: Approved)
