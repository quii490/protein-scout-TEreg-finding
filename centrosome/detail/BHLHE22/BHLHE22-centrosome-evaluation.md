...
# BHLHE22 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA064128, HPA064872, HPA067500
- **HPA IF reliability:** Approved
- **PubMed total:** 62 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000180828-BHLHE22
- **HPA location:** Nucleoplasm, Nuclear speckles, Centrosome, Cytosol
- **HPA main location:** Nucleoplasm, Nuclear speckles
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA064128, HPA064872, HPA067500 (IF reliability: Approved)
