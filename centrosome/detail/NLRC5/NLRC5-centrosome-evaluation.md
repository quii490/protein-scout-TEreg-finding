...
# NLRC5 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** NLRC5
- **Ensembl:** ENSG00000140853
- **HPA seed source:** centrosome
- **PubMed total:** 401 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 401 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000140853-NLRC5
