...
# PELI1 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** PELI1
- **Ensembl:** ENSG00000197329
- **HPA seed source:** both
- **PubMed total:** 196 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 196 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA source: both
- HPA URL: https://www.proteinatlas.org/ENSG00000197329-PELI1
