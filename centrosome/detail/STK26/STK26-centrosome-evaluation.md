...
# STK26 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA059921
- **HPA IF reliability:** Uncertain
- **PubMed total:** 71 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000134602-STK26
...
- HPA seed source: centrosome
- Antibody: HPA059921 (IF reliability: Uncertain)
