...
# RAB34 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000109113-RAB34
- **HPA location:** Nucleoplasm, Primary cilium, Centrosome, Basal body, Cytosol
- **HPA main location:** Nucleoplasm, Primary cilium
...
- HPA seed source: centrosome
- Antibody: HPA021366 (IF reliability: Approved)
