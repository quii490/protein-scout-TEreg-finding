...
# ZBED6 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA068807
- **HPA IF reliability:** Supported
- **PubMed total:** 50 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000257315-ZBED6
...
- HPA seed source: satellite
- Antibody: HPA068807 (IF reliability: Supported)
