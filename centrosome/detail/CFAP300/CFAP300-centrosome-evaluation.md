...
# CFAP300 — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000137691-CFAP300
- **HPA location:** Primary cilium, Centrosome
- **HPA main location:** Primary cilium, Centrosome
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA038585 (IF reliability: Approved)
