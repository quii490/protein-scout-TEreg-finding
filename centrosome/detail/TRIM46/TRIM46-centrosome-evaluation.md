...
# TRIM46 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA030391, HPA055583
- **HPA IF reliability:** Approved
- **PubMed total:** 73 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000163462-TRIM46
- **HPA location:** Microtubule ends, Cytokinetic bridge, Mitotic spindle, Primary cilium transition zone, Centrosome, Cytosol
- **HPA main location:** Microtubule ends, Mitotic spindle, Primary cilium transition zone
- **IF image:** Available
...
- **Total PubMed:** 73 papers
- **Centrosome-specific:** 1
...
|---|---:|---|
| Centrosome evidence | 16/20 | HPA centrosome annotation. |
| TE relevance | 5/20 | Pending manual TE-relevance assessment. |
| PubMed/literature | 6/20 | 73 papers total.  |
| PPI/network | 10/20 | Pending PPI assessment. |
| Structure/domain | 5/10 | Pending structural assessment. |
| Novelty/specificity | 4/10 | 73 papers.  |

- **Preliminary final score:** **45/100**
...
- HPA seed source: centrosome
- Antibody: HPA030391, HPA055583 (IF reliability: Approved)
