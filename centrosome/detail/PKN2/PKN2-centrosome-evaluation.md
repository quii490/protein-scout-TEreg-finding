...
# PKN2 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** PKN2
- **Ensembl:** ENSG00000065243
- **HPA seed source:** centrosome
- **PubMed total:** 118 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 118 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.

**Centrosome-specific papers:** 2

## 3. HPA Seed Evidence

- HPA source: centrosome
- HPA URL: https://www.proteinatlas.org/ENSG00000065243-PKN2
