...
# CLEC11A — Centrosome Module Evaluation
...
- **HPA antibody:** HPA042690
- **HPA IF reliability:** Approved
- **PubMed total:** 84 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000105472-CLEC11A
...
- HPA seed source: centrosome
- Antibody: HPA042690 (IF reliability: Approved)
