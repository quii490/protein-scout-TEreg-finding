...
# PRPF6 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA047106
- **HPA IF reliability:** Supported
- **PubMed total:** 57 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000101161-PRPF6
- **HPA location:** Nucleoplasm, Nuclear speckles, Vesicles, Centrosome, Basal body, Cytosol
- **HPA main location:** Nucleoplasm, Nuclear speckles, Basal body
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA047106 (IF reliability: Supported)
