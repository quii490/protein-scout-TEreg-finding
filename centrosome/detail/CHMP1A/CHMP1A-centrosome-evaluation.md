...
# CHMP1A — Centrosome Module Evaluation
...
- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000131165-CHMP1A
- **HPA location:** Nucleoplasm, Centrosome, Cytosol
- **HPA main location:** Nucleoplasm, Centrosome, Cytosol
...
- HPA seed source: centrosome
- Antibody: HPA006776 (IF reliability: Supported)
