...
# WDR54 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA043257, HPA053558
- **HPA IF reliability:** Approved
- **PubMed total:** 13 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** satellite ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000005448-WDR54
- **HPA location:** Nucleoli, Golgi apparatus, Vesicles, Primary cilium tip, Centriolar satellite, Cytosol, Acrosome, Flagellar centriole, Mid piece, Principal piece
- **HPA main location:** Golgi apparatus, Vesicles, Acrosome
- **IF image:** Available
...
- HPA seed source: satellite
- Antibody: HPA043257, HPA053558 (IF reliability: Approved)
