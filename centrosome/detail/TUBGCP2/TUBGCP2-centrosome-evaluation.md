...
# TUBGCP2 — Centrosome Module Evaluation

## 1. 基本信息

- **Gene:** TUBGCP2
- **Ensembl:** ENSG00000130640
- **HPA seed source:** centrosome
- **HPA antibody:** HPA037885
- **HPA IF reliability:** Supported
- **PubMed total:** 29 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000130640-TUBGCP2
...
- **Total PubMed:** 29 papers
- **Centrosome-specific:** 12
...
- HPA seed source: centrosome
- Antibody: HPA037885 (IF reliability: Supported)
