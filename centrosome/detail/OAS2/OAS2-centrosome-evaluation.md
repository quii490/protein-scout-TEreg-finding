...
# OAS2 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** OAS2
- **Ensembl:** ENSG00000111335
- **HPA seed source:** centrosome
- **PubMed total:** 367 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 367 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000111335-OAS2
