...
# LY9 — Centrosome Module Evaluation (ELIMINATED)

## 1. 基本信息

- **Gene:** LY9
- **Ensembl:** ENSG00000122224
- **HPA seed source:** satellite
- **PubMed total:** 165 papers ⚠️ **EXCEEDS THRESHOLD (>100)**

## 2. ELIMINATED

**Reason:** PubMed total = 165 (>100 threshold). Eliminated per centrosome module PubMed > 100 rule.
...
- HPA URL: https://www.proteinatlas.org/ENSG00000122224-LY9
