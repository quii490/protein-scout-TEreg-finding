...
# CKAP2 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA008410, HPA027821
- **HPA IF reliability:** Supported
- **PubMed total:** 94 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000136108-CKAP2
- **HPA location:** Microtubules, Mitotic spindle, Primary cilium, Centrosome, Basal body
- **HPA main location:** Microtubules, Mitotic spindle, Primary cilium
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA008410, HPA027821 (IF reliability: Supported)
