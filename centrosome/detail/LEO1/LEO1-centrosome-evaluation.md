...
# LEO1 — Centrosome Module Evaluation
...
- **HPA antibody:** HPA040741, HPA040941
- **HPA IF reliability:** Enhanced
- **PubMed total:** 93 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000166477-LEO1
- **HPA location:** Nucleoplasm, Nucleoli fibrillar center, Centrosome
- **HPA main location:** Nucleoplasm, Nucleoli fibrillar center
- **IF image:** Available
...
- HPA seed source: centrosome
- Antibody: HPA040741, HPA040941 (IF reliability: Enhanced)
