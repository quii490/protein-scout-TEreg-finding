...
# FAM161A — Centrosome Module Evaluation
...
- **HPA antibody:** HPA032119, HPA064830
- **HPA IF reliability:** Supported
- **PubMed total:** 72 papers

## 2. HPA Centrosome / Centriolar Satellite Evidence

- **HPA seed source:** centrosome ✓
- **HPA URL:** https://www.proteinatlas.org/ENSG00000170264-FAM161A
- **HPA location:** Nucleoplasm, Golgi apparatus, Centrosome, Basal body, Cytosol, Flagellar centriole
...
- **Total PubMed:** 72 papers
- **Centrosome-specific:** 20
...
- HPA seed source: centrosome
- Antibody: HPA032119, HPA064830 (IF reliability: Supported)
