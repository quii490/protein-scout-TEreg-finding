...
- Status TSV: `audit_work/codex_step1_status_verification_20260604_210250.tsv`
- Status summary: `audit_work/codex_step1_status_verification_20260604_210250.summary.md`
- Validate log: `audit_work/codex_step1_validate_strict_20260604_210250.log`
- Excel coverage TSV: `audit_work/codex_step1_excel_coverage_check_20260604_210250.tsv`
- Critical false rejection TSV: `audit_work/codex_step1_critical_false_rejection_check_20260604_210250.tsv`
- IF/PAE mismatch TSV: `audit_work/codex_step1_if_pae_true_mismatch_check_20260604_210250.tsv`
- Incomplete/template TSV: `audit_work/codex_step1_incomplete_template_check_20260604_210250.tsv`
...
| Excel covered genes | 4701 |
| Excel missing genes | 54 |
| Detail reports | 5685 |
...
| True CRITICAL false rejection remaining | 44 |
| HIGH false rejection risk | 27 |
| HPA IF true mismatch | 1038 |
| HPA IF audit false positives | 3691 |
| PAE true mismatch | 552 |
...
See `audit_work/codex_step1_critical_false_rejection_check_20260604_210250.tsv` for AIRIM, AKIP1, ALKBH2, AKIRIN1, ALKBH6, NAF1, AFMID, DNM3, ANAPC13, and MKLN1. The generated TSV records current status, evidence presence, risk, and whether a true remaining critical issue was found by this Step 1 audit.

## IF/PAE Sample Check

See `audit_work/codex_step1_if_pae_true_mismatch_check_20260604_210250.tsv`. The audit includes ELF2, DHX8, ERCC8 and all reports with stale IF/PAE patterns or local/embedded IF/PAE evidence.
...
Excel missing genes=54; true CRITICAL false rejection=44; true HPA IF mismatch=1038; true PAE mismatch=552; blocking incomplete/template=2
