...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | ×4 | 28 | HPA: Cytosol; 额外: Nucleoplasm, Nuclear speckles, Primary cilium; UniProt: Cytoplasm |
| 蛋白大小 | 10/10 | ×1 | 10 | 588 aa / 67.3 kDa |
| 研究新颖性 | 8/10 | ×5 | 40 | PubMed strict=25 篇 (≤40→8) |
| 三维结构 | 7/10 | ×3 | 21 | AlphaFold v6 pLDDT=79.6; PDB: 无 |
| 调控结构域 | 7/10 | ×2 | 14 | InterPro: IPR034907, IPR036850, IPR036249, IPR017937, IPR013 |
| PPI 网络 | 10/10 | ×3 | 30 | STRING 15 partners; IntAct 9 interactions |
