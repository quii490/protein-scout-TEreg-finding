...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | ×4 | 28 | HPA: Nucleoli; 额外: Nucleoplasm, Cytosol; UniProt: Nucleus; Cytoplasm, perinuclear region |
...
| 定位 | UniProt + HPA | Nucleus; Cytoplasm, perinuclear region / Nucleoli; 额外: Nucleoplasm, Cytosol | 一致 |
...
- Protein Atlas: https://www.proteinatlas.org/ENSG00000182208-MOB2/subcellular
