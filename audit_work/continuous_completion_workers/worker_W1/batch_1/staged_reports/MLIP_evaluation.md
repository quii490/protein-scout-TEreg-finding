...
| 维度 | 得分 | 满分 | 加权后 | 关键证据摘要 |
|------|------|------|--------|-------------|
| 核定位特异性 | 7/10 | ×4 | 28 | HPA: Nucleoplasm, Plasma membrane; 额外: Vesicles; UniProt: Nucleus; Nucleus envelope; Nucleus, PML body; Cytoplasm, cyt |
...
| UniProt | Nucleus; Nucleus envelope; Nucleus, PML body; Cytoplasm, cytosol; Cell membrane, sarcolemma | Swiss-Prot/TrEMBL |
...
| 定位 | UniProt + HPA | Nucleus; Nucleus envelope; Nucleus, PML body; Cyto / Nucleoplasm, Plasma membrane; 额外: Vesicles | 一致 |
...
- Protein Atlas: https://www.proteinatlas.org/ENSG00000146147-MLIP/subcellular
