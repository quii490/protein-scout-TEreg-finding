#!/usr/bin/env python3
"""Generate /180 re-evaluation reports for 30 genes from harvest packets."""
import json, os, sys
...
GENES = [
    "ADAM33", "ADPRM", "ANAPC10", "ANAPC11", "ANAPC13", "ANAPC2", "ANAPC4",
    "ANAPC5", "ANAPC7", "ANGEL1", "ANGEL2", "ANKEF1", "ANKS4B", "ANKS6",
    "ANXA11", "ANXA13", "ANXA5", "ANXA9", "AOPEP", "AP3B1", "AP5B1",
    "APBA1", "APBB3", "APIP", "APLF", "ARFGAP1", "ARFIP2", "ARID4A",
    "ARIH1", "ARIH2",
]
...
def generate_report(gene):
    ...
    if rejected:
        ...
        # Classify based on localization
...
print("Generating 30 full re-evaluation reports (/180 format)...")
print("=" * 60)
results = []
for gene in GENES:
    try:
