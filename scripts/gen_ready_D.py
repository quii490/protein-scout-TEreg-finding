#!/usr/bin/env python3
"""Generate /180 reports for ready D-genes from harvest packets. Skip already complete."""
...
ALL_GENES = "DNAJC11 DNAJC13 DNAJC16 DNAJC19 DNAJC22 DNAJC24 DNAJC27 DNAJC3 DNAJC4 DNAJC6 DNAJC8 DNAJC9 DOCK11 DOCK2 DOCK5 DOCK7 DOCK8 DOCK9 DPEP2 DPP3 DPP9 DPY19L3 DPY19L4 DSC1 DSG2 DSP DST DTNB DUSP1 DUSP10 DUSP13 DUSP2 DUSP4 DUSP5 DUSP6 DUT DHRS9 DLEU1 DLEU2 DLG2 DLG5 DLGAP2 DLGAP3 DMAC2 DMC1 DMPK DMXL2 DNAH12 DNAJA1".split()
...
def main():
    genes_unique = list(dict.fromkeys(ALL_GENES))
