#!/usr/bin/env python3
"""Fast batch: full /180 re-evaluation reports for 76 remaining genes.
...
GENES = [
    "DNLZ", "DNM1", "DNM2", "DNM3", "DNMBP", "DOCK3", "DPH3", "DPP8",
    "DR1", "DRG1", "DSCAML1", "DTNBP1", "DUSP28", "DUSP29", "DUSP3",
    "DYNLRB1", "DYNLRB2", "DYNLT1", "DYNLT2B", "DYNLT5", "ECI2", "ECM2",
    "EDEM1", "EEF1AKNMT", "EFCAB14", "EFEMP2", "EFHC2", "EFHD1", "EFNA1",
    "EFNB1", "EFNB3", "EFR3A", "EHMT2", "EIF1AD", "EIF2A", "EIF2B1",
    "EIF2B3", "EIF2B4", "EIF2B5", "EIF2D", "EIF2S2", "EIF3B", "EIF3C",
    "EIF3D", "EIF3E", "EIF3F", "EIF3G", "EIF3H", "EIF3I", "EIF3J",
    "EIF3K", "EIF3L", "EIF3M", "EIF4A1", "EIF4A2", "EIF4E", "EIF4E2",
    "EIF4G1", "EIF4G2", "EIF4G3", "EIF4H", "EIF5", "EIF5A", "EIF5AL1",
    "EIF5B", "EIF6", "ELF3", "ELF5", "ELOA", "ELOA2", "ELOA3P", "EMC4",
    "EMC7", "EMC9", "EML5", "ENKD1",
]
